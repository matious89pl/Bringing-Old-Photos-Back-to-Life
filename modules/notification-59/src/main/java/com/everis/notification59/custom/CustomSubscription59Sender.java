 ...
 * @author ccaravac
 */
public class CustomSubscription59Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription59Sender.class);
