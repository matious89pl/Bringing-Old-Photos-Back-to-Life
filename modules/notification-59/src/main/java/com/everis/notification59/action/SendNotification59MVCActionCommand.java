package com.everis.notification59.action;

import com.everis.notification59.constants.CustomNotification59Type;
import com.everis.notification59.constants.CustomNotifications59Constants;
import com.everis.notification59.constants.Notification59PortletKeys;
import com.everis.notification59.custom.CustomNotification59Handler;
import com.everis.notification59.custom.CustomSubscription59Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification59PortletKeys.NOTIFICATION59,
...
public class SendNotification59MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification59MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification59Handler.setTitleKey(title);
		CustomNotification59Handler.setBodyKey(body);
		...
		subscriptionSender.setClassName(SendNotification59MVCActionCommand.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(SendNotification59MVCActionCommand.class.getName(), 0);
