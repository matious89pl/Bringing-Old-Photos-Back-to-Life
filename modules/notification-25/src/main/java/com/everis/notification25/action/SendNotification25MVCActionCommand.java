package com.everis.notification25.action;

import com.everis.notification25.constants.CustomNotification25Type;
import com.everis.notification25.constants.CustomNotifications25Constants;
import com.everis.notification25.constants.Notification25PortletKeys;
import com.everis.notification25.custom.CustomNotification25Handler;
import com.everis.notification25.custom.CustomSubscription25Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification25PortletKeys.NOTIFICATION25,
...
public class SendNotification25MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification25MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification25Handler.setTitleKey("Tittle notification25");
		CustomNotification25Handler.setBodyKey("Body notification25");
		...
		String fromName = PropsUtil.get(CustomNotifications25Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications25Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		CustomSubscription25Sender subscriptionSender = new CustomSubscription25Sender();

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification25MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification25");
		subscriptionSender.setBody("Body notification25");

		subscriptionSender.setMailId("custom_notitication25", 0);

		int notificationType = CustomNotification25Type.NOTIFICATION_TYPE_USER_25;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification25PortletKeys.NOTIFICATION25;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification25MVCActionCommand.class.getName(), 0);
