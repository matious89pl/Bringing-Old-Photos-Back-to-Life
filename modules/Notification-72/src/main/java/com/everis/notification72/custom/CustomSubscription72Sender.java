 ...
 * @author ccaravac
 */
public class CustomSubscription72Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription72Sender.class);
