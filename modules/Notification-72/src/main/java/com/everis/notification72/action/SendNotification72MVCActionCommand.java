package com.everis.notification72.action;

import com.everis.notification72.constants.CustomNotification72Type;
import com.everis.notification72.constants.CustomNotifications72Constants;
import com.everis.notification72.constants.Notification72PortletKeys;
import com.everis.notification72.custom.CustomNotification72Handler;
import com.everis.notification72.custom.CustomSubscription72Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification72PortletKeys.NOTIFICATION72,
...
public class SendNotification72MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification72MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification72Handler.setTitleKey(title);
		CustomNotification72Handler.setBodyKey(body);

		CustomSubscription72Sender subscriptionSender = new CustomSubscription72Sender();
		/**
		 * Set up the EMAIL TYPE custom notification
		 */
		String entryTitle = "Admin User Login";

		String fromName = PropsUtil.get(CustomNotifications72Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications72Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification72MVCActionCommand.class.getName());
		...
		int notificationType = CustomNotification72Type.NOTIFICATION_TYPE_USER_72;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification72PortletKeys.NOTIFICATION72;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification72MVCActionCommand.class.getName(), 0);
