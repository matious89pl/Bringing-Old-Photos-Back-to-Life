package com.everis.notification49.action;

import com.everis.notification49.constants.CustomNotification49Type;
import com.everis.notification49.constants.CustomNotifications49Constants;
import com.everis.notification49.constants.Notification49PortletKeys;
import com.everis.notification49.custom.CustomNotification49Handler;
import com.everis.notification49.custom.CustomSubscription49Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification49PortletKeys.NOTIFICATION49,
...
public class SendNotification49MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification49MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification49Handler.setTitleKey(title);
		CustomNotification49Handler.setBodyKey(body);

		CustomSubscription49Sender subscriptionSender = new CustomSubscription49Sender();
		/**
		 * Set up the EMAIL TYPE custom notification
		 */
		String entryTitle = "Admin User Login";

		String fromName = PropsUtil.get(CustomNotifications49Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications49Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification49MVCActionCommand.class.getName());
		...
		int notificationType = CustomNotification49Type.NOTIFICATION_TYPE_USER_49;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification49PortletKeys.NOTIFICATION49;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification49MVCActionCommand.class.getName(), 0);
