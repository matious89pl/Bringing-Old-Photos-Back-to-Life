package com.everis.notification51.action;

import com.everis.notification51.constants.CustomNotification51Type;
import com.everis.notification51.constants.CustomNotifications51Constants;
import com.everis.notification51.constants.Notification51PortletKeys;
import com.everis.notification51.custom.CustomNotification51Handler;
import com.everis.notification51.custom.CustomSubscription51Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification51PortletKeys.NOTIFICATION51,
...
public class SendNotification51MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification51MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		String title = "Title Notification 51";
		String body = "Body Notification 51";
		
		CustomNotification51Handler.setTitleKey(title);
		CustomNotification51Handler.setBodyKey(body);

		CustomSubscription51Sender subscriptionSender = new CustomSubscription51Sender();
		/**
		 * Set up the EMAIL TYPE custom notification
		 */
		String entryTitle = "Admin User Login";

		String fromName = PropsUtil.get(CustomNotifications51Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications51Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification51MVCActionCommand.class.getName());
		...
		int notificationType = CustomNotification51Type.NOTIFICATION_TYPE_USER_51;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification51PortletKeys.NOTIFICATION51;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification51MVCActionCommand.class.getName(), 0);
