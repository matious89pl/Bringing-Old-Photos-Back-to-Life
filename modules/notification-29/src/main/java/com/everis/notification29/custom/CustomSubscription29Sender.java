 ...
 * @author ccaravac
 */
public class CustomSubscription29Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription29Sender.class);
