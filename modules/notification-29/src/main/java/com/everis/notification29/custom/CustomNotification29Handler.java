...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification29PortletKeys.NOTIFICATION29 }, service = UserNotificationHandler.class)
...
public class CustomNotification29Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification29Handler.class);

	public CustomNotification29Handler() {

		setPortletId(Notification29PortletKeys.NOTIFICATION29);
	}
