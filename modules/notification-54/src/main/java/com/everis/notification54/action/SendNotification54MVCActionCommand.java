package com.everis.notification54.action;

import com.everis.notification54.constants.CustomNotification54Type;
import com.everis.notification54.constants.CustomNotifications54Constants;
import com.everis.notification54.constants.Notification54PortletKeys;
import com.everis.notification54.custom.CustomNotification54Handler;
import com.everis.notification54.custom.CustomSubscription54Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification54PortletKeys.NOTIFICATION54,
...
public class SendNotification54MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification54MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification54Handler.setTitleKey(title);
		CustomNotification54Handler.setBodyKey(body);

		CustomSubscription54Sender subscriptionSender = new CustomSubscription54Sender();
		/**
		 * Set up the EMAIL TYPE custom notification
		 */
		String entryTitle = "Admin User Login";

		String fromName = PropsUtil.get(CustomNotifications54Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications54Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification54MVCActionCommand.class.getName());
		...
		int notificationType = CustomNotification54Type.NOTIFICATION_TYPE_USER_54;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification54PortletKeys.NOTIFICATION54;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification54MVCActionCommand.class.getName(), 0);
