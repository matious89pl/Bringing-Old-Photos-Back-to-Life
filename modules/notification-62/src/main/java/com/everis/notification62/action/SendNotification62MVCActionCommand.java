package com.everis.notification62.action;

import com.everis.notification62.constants.CustomNotification62Type;
import com.everis.notification62.constants.CustomNotifications62Constants;
import com.everis.notification62.constants.Notification62PortletKeys;
import com.everis.notification62.custom.CustomNotification62Handler;
import com.everis.notification62.custom.CustomSubscription62Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification62PortletKeys.NOTIFICATION62,
...
public class SendNotification62MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification62MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification62Handler.setTitleKey(title);
		CustomNotification62Handler.setBodyKey(body);

		CustomSubscription62Sender subscriptionSender = new CustomSubscription62Sender();
		/**
		 * Set up the EMAIL TYPE custom notification
		 */
		String entryTitle = "Admin User Login";

		String fromName = PropsUtil.get(CustomNotifications62Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications62Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification62MVCActionCommand.class.getName());
		...
		int notificationType = CustomNotification62Type.NOTIFICATION_TYPE_USER_62;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification62PortletKeys.NOTIFICATION62;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification62MVCActionCommand.class.getName(), 0);
