...
/**
 * Provides the local service interface for RfiLogs. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RfiLogsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RfiLogsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.everis.rec.rfilogs.service.impl.RfiLogsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the rfi logs local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RfiLogsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<RfiLogs> findRfiLogs(
	...
	public void newRFI(
		long userId, RfiLogs newRFI, ServiceContext serviceContext);
