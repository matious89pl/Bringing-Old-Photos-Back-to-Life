...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification74PortletKeys.NOTIFICATION74 }, service = UserNotificationHandler.class)
...
public class CustomNotification74Handler extends BaseUserNotificationHandler {

	private static String _TITLE_KEY74 = "Message";
	private static String _BODY_KEY74 = "{0} sent you a new message";
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification74Handler.class);

	public CustomNotification74Handler() {

		setPortletId(Notification74PortletKeys.NOTIFICATION74);
	}
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY74);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY74, new Object[] { username });
