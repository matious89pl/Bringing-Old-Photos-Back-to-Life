package com.everis.notification19.action;


import com.everis.notification19.constants.CustomNotification19Type;
import com.everis.notification19.constants.CustomNotifications19Constants;
import com.everis.notification19.constants.Notification19PortletKeys;
import com.everis.notification19.custom.CustomNotification19Handler;
import com.everis.notification19.custom.CustomSubscription19Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification19PortletKeys.NOTIFICATION19,
...
public class SendNotification19MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification19MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification19Handler.setTitleKey("Tittle notification19");
		CustomNotification19Handler.setBodyKey("Body notification19");
		...
		subscriptionSender.setClassName(SendNotification19MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification19");
		subscriptionSender.setBody("Body notification19");

		subscriptionSender.setMailId("custom_notitication19", 0);
		...
		subscriptionSender.addPersistedSubscribers(SendNotification19MVCActionCommand.class.getName(), 0);
