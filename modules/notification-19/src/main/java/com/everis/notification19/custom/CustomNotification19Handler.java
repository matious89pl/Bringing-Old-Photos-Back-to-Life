...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification19PortletKeys.NOTIFICATION19 }, service = UserNotificationHandler.class)
...
public class CustomNotification19Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification19Handler.class);

	public CustomNotification19Handler() {

		setPortletId(Notification19PortletKeys.NOTIFICATION19);
	}
