package com.everis.notification42.action;

import com.everis.notification42.constants.CustomNotification42Type;
import com.everis.notification42.constants.CustomNotifications42Constants;
import com.everis.notification42.constants.Notification42PortletKeys;
import com.everis.notification42.custom.CustomNotification42Handler;
import com.everis.notification42.custom.CustomSubscription42Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification42PortletKeys.NOTIFICATION42,
...
public class SendNotification42MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification42MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification42Handler.setTitleKey("Tittle notification42");
		CustomNotification42Handler.setBodyKey("Body notification42");
		...
		subscriptionSender.setClassName(SendNotification42MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification42");
		subscriptionSender.setBody("Body notification42");

		subscriptionSender.setMailId("custom_notitication42", 0);
		...
		subscriptionSender.addPersistedSubscribers(SendNotification42MVCActionCommand.class.getName(), 0);
