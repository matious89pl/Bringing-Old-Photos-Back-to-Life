 ...
 * @author scruzhid
 */
public class CustomSubscription42Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription42Sender.class);
