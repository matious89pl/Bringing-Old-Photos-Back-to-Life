...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification06PortletKeys.NOTIFICATION06 }, service = UserNotificationHandler.class)
...
public class CustomNotification06Handler extends BaseUserNotificationHandler {

	private static String _TITLE_KEY6 = "Message05";
	private static String _BODY_KEY6 = "{0} sent you a new message";
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification06Handler.class);

	public CustomNotification06Handler() {

		setPortletId(Notification06PortletKeys.NOTIFICATION06);
	}
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY6);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY6, new Object[] { username });
