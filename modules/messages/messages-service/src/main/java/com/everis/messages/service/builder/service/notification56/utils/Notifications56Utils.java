...
@Component(immediate = true, property = {}, service = Notifications56Utils.class)

public class Notifications56Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications56Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
		...
		title = "RFI Log - Pending";
		body = rfiTitle + "  has been updated to 'Pending' by " + link;
		...
		bodyEmail = rfiTitle + "  has been updated to 'Pending' by " + linkEmail;
		...
		subscriptionSender.setClassName(Notifications56Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications56Utils.class.getName(), 0);
