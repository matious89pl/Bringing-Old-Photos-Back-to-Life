 ...
 * @author lperezve
 */
public class CustomSubscription52Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription52Sender.class);
