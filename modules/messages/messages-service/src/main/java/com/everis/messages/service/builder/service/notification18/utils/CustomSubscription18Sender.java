 ...
 * @author ccaravac
 */
public class CustomSubscription18Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription18Sender.class);
