...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification14PortletKeys.NOTIFICATION14 }, service = UserNotificationHandler.class)
...
public class CustomNotification14Handler extends BaseUserNotificationHandler {

	private static String _TITLE_KEY14 = "Message";
	private static String _BODY_KEY14 = "{0} sent you a new message";
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification14Handler.class);

	public CustomNotification14Handler() {

		setPortletId(Notification14PortletKeys.NOTIFICATION14);
	}
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY14);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY14, new Object[] { username });
