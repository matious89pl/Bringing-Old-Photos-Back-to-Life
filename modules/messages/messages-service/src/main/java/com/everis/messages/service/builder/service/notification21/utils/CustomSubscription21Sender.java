 ...
 * @author ccaravac
 */
public class CustomSubscription21Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription21Sender.class);
