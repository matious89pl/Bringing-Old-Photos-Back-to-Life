 ...
 * @author lperezve
 */
public class CustomSubscription61Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription61Sender.class);
