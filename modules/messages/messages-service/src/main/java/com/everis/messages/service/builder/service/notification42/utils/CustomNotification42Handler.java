...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification42PortletKeys.NOTIFICATION42 }, service = UserNotificationHandler.class)
...
public class CustomNotification42Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification42Handler.class);

	public CustomNotification42Handler() {

		setPortletId(Notification42PortletKeys.NOTIFICATION42);
	}
