 ...
 *
 */
public class CustomSubscription76Sender extends SubscriptionSender {
	
	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription76Sender.class);
