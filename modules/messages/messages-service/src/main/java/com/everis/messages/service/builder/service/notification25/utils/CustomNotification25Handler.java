...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification25PortletKeys.NOTIFICATION25 }, service = UserNotificationHandler.class)
...
public class CustomNotification25Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification25Handler.class);

	public CustomNotification25Handler() {

		setPortletId(Notification25PortletKeys.NOTIFICATION25);
	}
