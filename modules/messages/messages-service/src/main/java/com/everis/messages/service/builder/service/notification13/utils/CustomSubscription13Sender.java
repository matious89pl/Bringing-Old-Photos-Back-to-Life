 ...
 * @author ccaravac
 */
public class CustomSubscription13Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription13Sender.class);
	...
	public void sendNotification13(User user) throws Exception {
