...
@Component(immediate = true, property = {}, service = Notifications70Utils.class)

public class Notifications70Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications70Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
		...
		title = "Training, Guidance and Surveys log - Completed";
		body = activityName
				+ " has been completed on your organisations Training, Guidance and Surveys log. Please navigate to your organisation"
				+ HtmlUtil.escape("'") + "s "
		...
		subscriptionSender.setClassName(Notifications70Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications70Utils.class.getName(), 0);
