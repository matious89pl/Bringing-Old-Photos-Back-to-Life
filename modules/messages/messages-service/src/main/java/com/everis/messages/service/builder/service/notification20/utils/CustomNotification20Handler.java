...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification20PortletKeys.NOTIFICATION20 }, service = UserNotificationHandler.class)
...
public class CustomNotification20Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification20Handler.class);

	public CustomNotification20Handler() {

		setPortletId(Notification20PortletKeys.NOTIFICATION20);
	}
