...
@Component(immediate = true, property = {}, service = Notifications57Utils.class)

public class Notifications57Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications57Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
		...
		title = "RFI Log -Re-opened";
		body = rfiTitle + " has been re-opened on your organisations RFI log. Please navigate to your organisation"
		...
		bodyEmail = rfiTitle + " has been re-opened on your organisations RFI log. Please navigate to your organisation"
		...
		subscriptionSender.setClassName(Notifications57Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications57Utils.class.getName(), 0);
