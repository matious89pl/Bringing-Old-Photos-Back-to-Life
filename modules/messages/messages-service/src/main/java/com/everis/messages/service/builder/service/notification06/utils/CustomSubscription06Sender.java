 ...
 * @author ccaravac
 */
public class CustomSubscription06Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription06Sender.class);
	...
	public void sendNotification6(User user) throws Exception {
