 ...
 *
 */
public class CustomSubscription44Sender extends SubscriptionSender {
	
	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription44Sender.class);
