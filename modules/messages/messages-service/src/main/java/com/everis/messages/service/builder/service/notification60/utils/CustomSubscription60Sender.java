 ...
 * @author lperezve
 */
public class CustomSubscription60Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription60Sender.class);
