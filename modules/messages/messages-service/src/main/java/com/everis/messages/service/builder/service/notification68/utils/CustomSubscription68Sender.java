 ...
 * @author lperezve
 */
public class CustomSubscription68Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription68Sender.class);
