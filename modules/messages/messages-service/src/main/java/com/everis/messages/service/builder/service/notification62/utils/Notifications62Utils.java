package com.everis.messages.service.builder.service.notification62.utils;
...
@Component(immediate = true, property = {}, service = Notifications62Utils.class)

public class Notifications62Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications62Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
		...
		title = "Remediation tracker action - Completed";
		body = activityName
				+ " has been completed on your organisations Remediation log. Please navigate to your organisation"
				+ HtmlUtil.escape("'") + "s "
		...
		subscriptionSender.setClassName(Notifications62Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications62Utils.class.getName(), 0);
