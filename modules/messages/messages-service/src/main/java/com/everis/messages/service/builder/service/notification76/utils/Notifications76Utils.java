package com.everis.messages.service.builder.service.notification76.utils;
...
@Component(immediate = true, property = {}, service = Notifications76Utils.class)

public class Notifications76Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications76Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long resourcePK)
		...
		String title = "Initial Change Report new due date for comments";
		String body = "An Initial Change Report for " + changeProposalReference
		...
		subscriptionSender.setClassName(Notifications76Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications76Utils.class.getName(), 0);
