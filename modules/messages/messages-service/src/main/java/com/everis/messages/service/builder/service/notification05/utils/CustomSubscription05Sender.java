 ...
 * @author ccaravac
 */
public class CustomSubscription05Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription05Sender.class);
	...
	public void sendNotification5(User user) throws Exception {
