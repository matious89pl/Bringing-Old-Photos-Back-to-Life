...
@Component(immediate = true, property = {}, service = Notifications60Utils.class)

public class Notifications60Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications60Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long siteGroupId,
		...
		title = "RFI Log - missed/passed";
		body = rfilogname + " is now overdue on your organisations RFI log, please navigate to your organisation "
		...
		bodyEmail = rfilogname + " is now overdue on your organisations RFI log, please navigate to your organisation "
		...
		subscriptionSender.setClassName(Notifications60Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications60Utils.class.getName(), 0);
