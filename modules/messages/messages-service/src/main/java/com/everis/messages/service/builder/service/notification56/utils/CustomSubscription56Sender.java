 ...
 * @author lperezve
 */
public class CustomSubscription56Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription56Sender.class);
