 ...
 * @author ccaravac
 */
public class CustomSubscription04Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription04Sender.class);
	...
	public void sendNotification4(User user) throws Exception {
