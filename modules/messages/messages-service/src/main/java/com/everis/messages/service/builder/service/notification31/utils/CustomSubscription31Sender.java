 ...
 * @author ccaravac
 */
public class CustomSubscription31Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription31Sender.class);
