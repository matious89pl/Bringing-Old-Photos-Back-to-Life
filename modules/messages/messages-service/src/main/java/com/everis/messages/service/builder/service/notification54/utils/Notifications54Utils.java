package com.everis.messages.service.builder.service.notification54.utils;
...
@Component(immediate = true, property = {}, service = Notifications54Utils.class)

public class Notifications54Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications54Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long siteGroupId,
		...
		body = activityName
				+ " is due in 10 working days on your organisations Activity log, please navigate to your organisation "
		...
		subscriptionSender.setClassName(Notifications54Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications54Utils.class.getName(), 0);
