...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification10PortletKeys.NOTIFICATION10 }, service = UserNotificationHandler.class)
...
public class CustomNotification10Handler extends BaseUserNotificationHandler {

	private static String _TITLE_KEY10 = "Message";
	private static String _BODY_KEY10 = "{0} sent you a new message";
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification10Handler.class);

	public CustomNotification10Handler() {

		setPortletId(Notification10PortletKeys.NOTIFICATION10);
	}
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY10);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY10, new Object[] { username });
