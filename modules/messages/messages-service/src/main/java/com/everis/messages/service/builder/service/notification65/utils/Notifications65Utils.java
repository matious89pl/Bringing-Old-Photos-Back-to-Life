package com.everis.messages.service.builder.service.notification65.utils;
...
@Component(immediate = true, property = {}, service = Notifications65Utils.class)

public class Notifications65Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications65Utils.class);

	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
			long siteGroupId, String remediationTitle, String urlEmail) throws PortalException {
		...
		title = "Remediation Tracker - Document Added by Code Manager";
		body = "A document has been uploaded to " + remediationTitle + ", please navigate to your organisation " + link
				+ " for more details";
		...
		bodyEmail = "A document has been uploaded to " + remediationTitle + ", please navigate to your organisation " + linkEmail
				+ " for more details";
		...
		subscriptionSender.setClassName(Notifications65Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications65Utils.class.getName(), 0);
