 ...
 * @author lperezve
 */
public class CustomSubscription16Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription16Sender.class);
	...
	public void sendNotification16(User user) throws Exception {
