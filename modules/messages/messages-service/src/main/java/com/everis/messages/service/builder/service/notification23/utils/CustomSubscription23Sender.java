 ...
 * @author ccaravac
 */
public class CustomSubscription23Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription23Sender.class);
