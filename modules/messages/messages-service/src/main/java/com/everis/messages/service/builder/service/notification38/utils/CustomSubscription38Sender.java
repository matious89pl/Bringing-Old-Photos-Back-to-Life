 ...
 * @author ccaravac
 */
public class CustomSubscription38Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription38Sender.class);
