...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification04PortletKeys.NOTIFICATION04 }, service = UserNotificationHandler.class)
...
public class CustomNotification04Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification04Handler.class);

	public CustomNotification04Handler() {

		setPortletId(Notification04PortletKeys.NOTIFICATION04);
	}
