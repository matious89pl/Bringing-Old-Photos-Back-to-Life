package com.everis.messages.service.builder.service.notification17.utils;
...
@Component(immediate = true, property = {}, service = Notifications17Utils.class)

public class Notifications17Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications17Utils.class);
	...
	public void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext,
		...
		try {
			...
			title = "Approved Change Proposal Notification";
			body = cpReference + " has been approved " + link;
			CustomNotification17Handler.setTitleKey(title);
			CustomNotification17Handler.setBodyKey(body);
		...
		subscriptionSender.setClassName(Notifications17Utils.class.getName());
		...
		subscriptionSender.setMailId("custom_notitication17 to REC_Stakeholder", 0);
		...
		subscriptionSender.addPersistedSubscribers(Notifications17Utils.class.getName(), 0);
