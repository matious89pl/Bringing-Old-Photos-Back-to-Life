 ...
 * @author ccaravac
 */
public class CustomSubscription25Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription25Sender.class);
