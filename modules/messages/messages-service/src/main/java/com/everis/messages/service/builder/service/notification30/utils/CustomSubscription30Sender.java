 ...
 * @author ccaravac
 */
public class CustomSubscription30Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription30Sender.class);
	...
	public void sendNotification(User user) throws Exception {
		...
		try {
			...
			logger.info("sending notification to user: " + user.getScreenName());
