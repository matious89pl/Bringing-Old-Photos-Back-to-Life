 ...
 * @author ccaravac
 */
public class CustomSubscription09Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription09Sender.class);
	...
	public void sendNotification9(User user) throws Exception {
