...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification28PortletKeys.NOTIFICATION28 }, service = UserNotificationHandler.class)
...
public class CustomNotification28Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification28Handler.class);

	public CustomNotification28Handler() {

		setPortletId(Notification28PortletKeys.NOTIFICATION28);
	}
