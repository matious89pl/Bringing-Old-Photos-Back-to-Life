...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification53PortletKeys.NOTIFICATION53 }, service = UserNotificationHandler.class)
...
public class CustomNotification53Handler extends BaseUserNotificationHandler {

	private static String _TITLE_KEY53 = "Message";
	private static String _BODY_KEY53 = "{0} sent you a new message";
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification53Handler.class);

	public CustomNotification53Handler() {

		setPortletId(Notification53PortletKeys.NOTIFICATION53);
	}
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY53);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY53, new Object[] { username });
