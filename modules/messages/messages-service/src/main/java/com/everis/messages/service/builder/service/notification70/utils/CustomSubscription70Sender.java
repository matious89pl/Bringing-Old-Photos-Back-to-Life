 ...
 * @author lperezve
 */
public class CustomSubscription70Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription70Sender.class);
