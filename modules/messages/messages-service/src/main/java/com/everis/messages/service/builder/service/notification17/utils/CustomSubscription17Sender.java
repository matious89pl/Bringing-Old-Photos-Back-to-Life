 ...
 * @author ccaravac
 */
public class CustomSubscription17Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription17Sender.class);
