 ...
 * @author lperezve
 */
public class CustomSubscription71Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription71Sender.class);
