package com.everis.messages.service.builder.service.notification66.utils;
...
@Component(immediate = true, property = {}, service = Notifications66Utils.class)

public class Notifications66Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications66Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
		...
		title = "Remediation Tracker - Document added by REC Party User";
		body = "A document has been uploaded to " + remediationTitle + " within " + siteName + " " + link;
		...
		bodyEmail = "A document has been uploaded to " + remediationTitle + " within " + siteName + " " + linkEmail;
		...
		subscriptionSender.setClassName(Notifications66Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications66Utils.class.getName(), 0);
