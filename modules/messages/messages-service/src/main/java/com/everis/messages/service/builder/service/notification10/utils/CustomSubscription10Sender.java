 ...
 * @author ccaravac
 */
public class CustomSubscription10Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription10Sender.class);
	...
	public void sendNotification10(User user) throws Exception {
