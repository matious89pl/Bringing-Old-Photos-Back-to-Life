 ...
 * @author lperezve
 */
public class CustomSubscription55Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription55Sender.class);
