package com.everis.messages.service.builder.service.notification49.utils;
...
@Component(immediate = true, property = {}, service = Notifications49Utils.class)

public class Notifications49Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications49Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
		...
		body = remedationTitle
				+ " has been added to your organisations Remediation log. Please navigate to your organisation"
		...
		subscriptionSender.setClassName(Notifications49Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications49Utils.class.getName(), 0);
