package com.everis.messages.service.builder.service.notification67.utils;
...
@Component(immediate = true, property = {}, service = Notifications67Utils.class)

public class Notifications67Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications67Utils.class);

	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long siteGroupId,
			String remediationName) throws PortalException {
		...
		title = "Remediation tracker action - missed/passed";
		body = remediationName
				+ "  is now overdue on your organisations Remediation log, please navigate to your organisation " + link
				+ " for more details";
		...
		bodyEmail = remediationName
				+ "  is now overdue on your organisations Remediation log, please navigate to your organisation "
		...
		subscriptionSender.setClassName(Notifications67Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications67Utils.class.getName(), 0);
