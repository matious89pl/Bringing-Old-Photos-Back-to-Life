...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification59PortletKeys.NOTIFICATION59 }, service = UserNotificationHandler.class)
...
public class CustomNotification59Handler extends BaseUserNotificationHandler {

	private static String _TITLE_KEY59 = "Message";
	private static String _BODY_KEY59 = "{0} sent you a new message";
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification59Handler.class);

	public CustomNotification59Handler() {

		setPortletId(Notification59PortletKeys.NOTIFICATION59);
	}
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY59);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY59, new Object[] { username });
