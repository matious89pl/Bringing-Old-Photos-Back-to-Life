 ...
 * @author lperezve
 */
public class CustomSubscription62Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription62Sender.class);
