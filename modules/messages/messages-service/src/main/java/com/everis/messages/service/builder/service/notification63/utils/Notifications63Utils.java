...
@Component(immediate = true, property = {}, service = Notifications63Utils.class)

public class Notifications63Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications63Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
		...
		title = "Remediation tracker action - Pending";
		...
		subscriptionSender.setClassName(Notifications63Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications63Utils.class.getName(), 0);
