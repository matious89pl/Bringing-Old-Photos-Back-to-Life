 ...
 * @author ccaravac
 */
public class CustomSubscription11Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription11Sender.class);
	...
	public void sendNotification11(User user) throws Exception {
