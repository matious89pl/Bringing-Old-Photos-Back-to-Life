...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification43PortletKeys.NOTIFICATION43 }, service = UserNotificationHandler.class)
...
public class CustomNotification43Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification43Handler.class);

	public CustomNotification43Handler() {

		setPortletId(Notification43PortletKeys.NOTIFICATION43);
	}
