...
@Component(immediate = true, property = {}, service = Notifications74Utils.class)

public class Notifications74Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications74Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long siteGroupId,
		...
		title = "Training, Guidance and Surveys log - Reminder";
		body = resourceTitle
				+ "  is due in 10 working days on your organisations Training, Guidance and Surveys log, please navigate to your organisation "
		...
		subscriptionSender.setClassName(Notifications74Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications74Utils.class.getName(), 0);
