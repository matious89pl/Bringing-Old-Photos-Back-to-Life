...
@Component(immediate = true, property = {}, service = Notifications48Utils.class)

public class Notifications48Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications48Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
		...
		title = "RFI Log";
		body = rfiTitle + " has been added to your organisations RFI log. Please navigate to your organisation"
		...
		bodyEmail = rfiTitle + " has been added to your organisations RFI log. Please navigate to your organisation"
				+ HtmlUtil.escape("'") + "s "
		...
		subscriptionSender.setClassName(Notifications48Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications48Utils.class.getName(), 0);
