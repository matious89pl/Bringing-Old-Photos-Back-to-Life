...
@Component(immediate = true, property = {}, service = Notifications50Utils.class)

public class Notifications50Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications50Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
		...
		title = "Activity Log - Completed";
		body = activityName
				+ " has been completed on your organisations activity log. Please navigate to your organisation"
		...
		subscriptionSender.setClassName(Notifications50Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications50Utils.class.getName(), 0);
