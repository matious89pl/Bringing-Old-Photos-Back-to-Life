 ...
 * @author lperezve
 */
public class CustomSubscription58Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription58Sender.class);
