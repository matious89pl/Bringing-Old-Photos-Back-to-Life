 ...
 * @author ccaravac
 */
public class CustomSubscription26Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription26Sender.class);
