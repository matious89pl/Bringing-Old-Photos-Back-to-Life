 ...
 * @author lperezve
 */
public class CustomSubscription67Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription67Sender.class);
