...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification17PortletKeys.NOTIFICATION17 }, service = UserNotificationHandler.class)
...
public class CustomNotification17Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification17Handler.class);

	public CustomNotification17Handler() {

		setPortletId(Notification17PortletKeys.NOTIFICATION17);
	}
