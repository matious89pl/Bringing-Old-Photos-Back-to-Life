 ...
 * @author ccaravac
 */
public class CustomSubscription27Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription27Sender.class);
