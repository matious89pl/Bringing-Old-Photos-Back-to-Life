...
@Component(immediate = true, property = {}, service = Notifications69Utils.class)

public class Notifications69Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications69Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
		...
		title = "Training, Guidance and Surveys log";
		body = activityTitle
				+ " has been added to your organisations Training, Guidance and Surveys log. Please navigate to your organisation"
				+ HtmlUtil.escape("'") + "s "
		...
		subscriptionSender.setClassName(Notifications69Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications69Utils.class.getName(), 0);
