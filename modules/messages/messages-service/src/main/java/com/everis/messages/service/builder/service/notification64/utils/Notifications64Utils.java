package com.everis.messages.service.builder.service.notification64.utils;
...
@Component(immediate = true, property = {}, service = Notifications64Utils.class)

public class Notifications64Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications64Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
		...
		title = "Remediation tracker action - Re-opened";
		body = activityName
				+ " has been re-opened on your organisations Remediation log. Please navigate to your organisation"
		...
		bodyEmail = activityName + " has been re-opened on your organisations Remediation log. Please navigate to your organisation"
		...
		subscriptionSender.setClassName(Notifications64Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications64Utils.class.getName(), 0);
