...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification22PortletKeys.NOTIFICATION22 }, service = UserNotificationHandler.class)
...
public class CustomNotification22Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification22Handler.class);

	public CustomNotification22Handler() {

		setPortletId(Notification22PortletKeys.NOTIFICATION22);
	}
