package com.everis.messages.service.builder.service.notification58.utils;
...
@Component(immediate = true, property = {}, service = Notifications58Utils.class)

public class Notifications58Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications58Utils.class);

	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId, long siteGroupId,
			String rfiTitle, String urlEmail) throws PortalException {
		...
		title = "RFI Log - Document Added by Code Manager";
		body = "A document has been uploaded to " + rfiTitle + ", please navigate to your organisation " + link
				+ " for more details";
		...
		bodyEmail = "A document has been uploaded to " + rfiTitle + ", please navigate to your organisation " + linkEmail
				+ " for more details";
		...
		subscriptionSender.setClassName(Notifications58Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications58Utils.class.getName(), 0);
