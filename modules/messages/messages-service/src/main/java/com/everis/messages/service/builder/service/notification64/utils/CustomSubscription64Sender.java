 ...
 * @author lperezve
 */
public class CustomSubscription64Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription64Sender.class);
