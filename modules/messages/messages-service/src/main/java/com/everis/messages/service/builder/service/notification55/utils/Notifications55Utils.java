package com.everis.messages.service.builder.service.notification55.utils;
...
@Component(immediate = true, property = {}, service = Notifications55Utils.class)

public class Notifications55Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications55Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
		...
		title = "RFI Log - Completed";
		body = rfiTitle + " has been completed on your organisations RFI log. Please navigate to your organisation"
				+ HtmlUtil.escape("'") + "s "
		...
		bodyEmail = rfiTitle + " has been completed on your organisations RFI log. Please navigate to your organisation"
				+ HtmlUtil.escape("'") + "s "
		...
		subscriptionSender.setClassName(Notifications55Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications55Utils.class.getName(), 0);
