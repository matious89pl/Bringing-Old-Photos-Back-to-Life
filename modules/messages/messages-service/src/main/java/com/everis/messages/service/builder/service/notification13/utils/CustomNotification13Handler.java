...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification13PortletKeys.NOTIFICATION13 }, service = UserNotificationHandler.class)
...
public class CustomNotification13Handler extends BaseUserNotificationHandler {

	private static String _TITLE_KEY13 = "Message";
	private static String _BODY_KEY13 = "{0} sent you a new message";
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification13Handler.class);

	public CustomNotification13Handler() {

		setPortletId(Notification13PortletKeys.NOTIFICATION13);
	}
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY13);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY13, new Object[] { username });
