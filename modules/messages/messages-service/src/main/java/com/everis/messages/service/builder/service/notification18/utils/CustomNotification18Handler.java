...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification18PortletKeys.NOTIFICATION18 }, service = UserNotificationHandler.class)
...
public class CustomNotification18Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification18Handler.class);

	public CustomNotification18Handler() {

		setPortletId(Notification18PortletKeys.NOTIFICATION18);
	}
