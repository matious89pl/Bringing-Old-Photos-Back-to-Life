 ...
 * @author lperezve
 */
public class CustomSubscription69Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription69Sender.class);
