package com.everis.messages.service.builder.service.notification07.utils;
...
@Component(immediate = true, property = {}, service = Notifications07Utils.class)

public class Notifications07Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications07Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long resourcePK)
		...
		String title = "Preliminary Change Report published for comments";
		...
		subscriptionSender.setClassName(Notifications07Utils.class.getName());
		...
		int notificationType = CustomNotificationType.NOTIFICATION_TYPE_USER_07;
		...
		subscriptionSender.addPersistedSubscribers(Notifications07Utils.class.getName(), 0);
