 ...
 * @author ccaravac
 */
public class CustomSubscription28Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription28Sender.class);
