package com.everis.messages.service.builder.service.notification52.utils;
...
@Component(immediate = true, property = {}, service = Notifications52Utils.class)

public class Notifications52Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications52Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
		...
		title = "Activity Log - Re-opened";
		body = activityName
				+ " has been re-opened on your organisations activity log. Please navigate to your organisation"
		...
		subscriptionSender.setClassName(Notifications52Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications52Utils.class.getName(), 0);
