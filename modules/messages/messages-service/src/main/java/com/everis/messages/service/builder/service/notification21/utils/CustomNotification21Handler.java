...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification21PortletKeys.NOTIFICATION21 }, service = UserNotificationHandler.class)
...
public class CustomNotification21Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification21Handler.class);

	public CustomNotification21Handler() {

		setPortletId(Notification21PortletKeys.NOTIFICATION21);
	}
