...
public class CustomNotification05Handler extends BaseUserNotificationHandler {
	...
	private static String _TITLE_KEY5 = "Message05";
	private static String _BODY_KEY5 = "{0} sent you a new message";
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY5);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY5, new Object[] { username });
