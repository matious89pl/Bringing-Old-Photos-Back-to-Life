 ...
 * @author lperezve
 */
public class CustomSubscription51Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription51Sender.class);
