...
@Component(immediate = true, property = {}, service = Notifications43Utils.class)

public class Notifications43Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications43Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, long userId, long resourcePrimaryKey, long siteGroupId,
		...
		try {
			...
			String link = " <a style='color:#70ada3;' onclick='@LINK1'> Go to Nomination Page.</a>";

			title = "Nominations Process Open - please participate";
			body = "A new Nominations process has been opened and you have been requested to participate. Please provide your nomination here. "
					+ link;
		...
		subscriptionSender.setClassName(Notifications43Utils.class.getName());
		...
		subscriptionSender.setMailId("custom_notitication43 to Responsible Service Provider(organisation)", 0);
		...
		subscriptionSender.addPersistedSubscribers(Notifications43Utils.class.getName(), 0);
