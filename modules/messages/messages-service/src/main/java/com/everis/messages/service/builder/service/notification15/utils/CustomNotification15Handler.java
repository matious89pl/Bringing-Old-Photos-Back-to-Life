...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification15PortletKeys.NOTIFICATION15 }, service = UserNotificationHandler.class)
...
public class CustomNotification15Handler extends BaseUserNotificationHandler {

	private static String _TITLE_KEY15 = "Message";
	private static String _BODY_KEY15 = "{0} sent you a new message";
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification15Handler.class);

	public CustomNotification15Handler() {

		setPortletId(Notification15PortletKeys.NOTIFICATION15);
	}
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY15);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY15, new Object[] { username });
