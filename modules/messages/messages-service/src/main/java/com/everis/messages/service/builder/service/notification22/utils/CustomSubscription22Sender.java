 ...
 * @author ccaravac
 */
public class CustomSubscription22Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription22Sender.class);
