 ...
 * @author lperezve
 */
public class CustomSubscription54Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription54Sender.class);
