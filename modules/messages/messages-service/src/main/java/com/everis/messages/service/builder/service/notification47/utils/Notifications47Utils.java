package com.everis.messages.service.builder.service.notification47.utils;
...
@Component(immediate = true, property = {}, service = Notifications47Utils.class)

public class Notifications47Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications47Utils.class);

	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
			long siteGroupId, String activityTitle, String urlEmail) throws PortalException {
		...
		title = "Activity Log";
		body = activityTitle
				+ " has been added to your organisations activity log. Please navigate to your organisation"
				+ HtmlUtil.escape("'") + "s " + link
				+ " for more details";
		...
		subscriptionSender.setClassName(Notifications47Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications47Utils.class.getName(), 0);
