...
@Component(immediate = true, property = {}, service = Notifications68Utils.class)

public class Notifications68Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications68Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long siteGroupId,
		...
		title = "Remediation tracker action - Reminder";
		body = remediationName
				+ "  is due in 10 working days on your organisations Remediation log, please navigate to your organisation "
		...
		subscriptionSender.setClassName(Notifications68Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications68Utils.class.getName(), 0);
