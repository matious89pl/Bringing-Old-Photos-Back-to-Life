 ...
 * @author lperezve
 */
public class CustomSubscription50Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription50Sender.class);
