package com.everis.messages.service.builder.service.notification12.utils;
...
@Component(immediate = true, property = {}, service = Notifications12Utils.class)

public class Notifications12Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications12Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long resourcePK)
		...
		logger.info("FinalchangeProposalDate: " + changeProposalDate);
		...
		title = "Final Change Report published for comments";
		body = "A Final Change Report for " + changeProposalReference + " has been published for comments. Go to the " + link
		...
		subscriptionSender.setClassName(Notifications12Utils.class.getName());
		...
		subscriptionSender.setMailId("custom_notitication12 to stake holder", 0);
		...
		subscriptionSender.addPersistedSubscribers(Notifications12Utils.class.getName(), 0);
		...
		try {
			...
			for (User user : userList) {
				...
				subscriptionSender.sendNotification12(user);
			}
