package com.everis.messages.service.builder.service.notification61.utils;
...
@Component(immediate = true, property = {}, service = Notifications61Utils.class)

public class Notifications61Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications61Utils.class);

	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long siteGroupId,
			String rfilogname) throws PortalException {
		...
		title = "RFI Log - Reminder";
		body = rfilogname
				+ " is due in 10 working days on your organisations RFI log, please navigate to your organisation "
		...
		subscriptionSender.setClassName(Notifications61Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications61Utils.class.getName(), 0);
