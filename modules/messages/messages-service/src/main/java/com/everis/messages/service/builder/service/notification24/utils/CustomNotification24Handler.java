...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification24PortletKeys.NOTIFICATION24 }, service = UserNotificationHandler.class)
...
public class CustomNotification24Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification24Handler.class);

	public CustomNotification24Handler() {

		setPortletId(Notification24PortletKeys.NOTIFICATION24);
	}
