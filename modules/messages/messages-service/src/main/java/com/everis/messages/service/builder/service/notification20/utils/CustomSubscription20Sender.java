 ...
 * @author ccaravac
 */
public class CustomSubscription20Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription20Sender.class);
