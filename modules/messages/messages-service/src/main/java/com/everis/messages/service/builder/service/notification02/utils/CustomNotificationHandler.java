...
@Component(immediate = true, property = {
		"javax.portlet.name=" + NotificationPortletKeys.NOTIFICATION02 }, service = UserNotificationHandler.class)
...
public class CustomNotificationHandler extends BaseUserNotificationHandler {
	...
	private static String _TITLE_KEY02 = "Message";
	private static String _BODY_KEY02 = "{0} sent you a new message";
	...
	public CustomNotificationHandler() {
		...
		setPortletId(NotificationPortletKeys.NOTIFICATION02);
	}
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY02);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY02, new Object[] { username });
