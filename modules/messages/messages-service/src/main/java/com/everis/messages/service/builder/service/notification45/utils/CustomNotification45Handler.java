...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification45PortletKeys.NOTIFICATION45 }, service = UserNotificationHandler.class)
...
public class CustomNotification45Handler extends BaseUserNotificationHandler {

	private static String _TITLE_KEY45 = "Message";
	private static String _BODY_KEY45 = "{0} sent you a new message";
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification45Handler.class);

	public CustomNotification45Handler() {

		setPortletId(Notification45PortletKeys.NOTIFICATION45);
	}
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY45);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY45, new Object[] { username });
