package com.everis.messages.service.builder.service.notification51.utils;
...
@Component(immediate = true, property = {}, service = Notifications51Utils.class)

public class Notifications51Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications51Utils.class);
	...
	public void notifySubscribers(HashSet<User> userList, ServiceContext serviceContext, long currentUserId,
		...
		subscriptionSender.setClassName(Notifications51Utils.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(Notifications51Utils.class.getName(), 0);
