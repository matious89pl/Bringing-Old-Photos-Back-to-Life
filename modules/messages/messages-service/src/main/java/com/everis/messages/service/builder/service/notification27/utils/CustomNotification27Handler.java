...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification27PortletKeys.NOTIFICATION27 }, service = UserNotificationHandler.class)
...
public class CustomNotification27Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification27Handler.class);

	public CustomNotification27Handler() {

		setPortletId(Notification27PortletKeys.NOTIFICATION27);
	}
