 ...
 * @author lperezve
 */
public class CustomSubscription47Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription47Sender.class);
