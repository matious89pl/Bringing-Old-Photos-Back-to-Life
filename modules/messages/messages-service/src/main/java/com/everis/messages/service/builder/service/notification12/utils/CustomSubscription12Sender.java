 ...
 * @author ccaravac
 */
public class CustomSubscription12Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription12Sender.class);
	...
	public void sendNotification12(User user) throws Exception {
