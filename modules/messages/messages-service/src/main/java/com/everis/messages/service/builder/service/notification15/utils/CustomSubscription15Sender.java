 ...
 * @author ccaravac
 */
public class CustomSubscription15Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription15Sender.class);
	...
	public void sendNotification15(User user) throws Exception {
