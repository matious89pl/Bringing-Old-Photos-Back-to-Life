...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification38PortletKeys.NOTIFICATION38 }, service = UserNotificationHandler.class)
...
public class CustomNotification38Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification38Handler.class);

	public CustomNotification38Handler() {

		setPortletId(Notification38PortletKeys.NOTIFICATION38);
	}
