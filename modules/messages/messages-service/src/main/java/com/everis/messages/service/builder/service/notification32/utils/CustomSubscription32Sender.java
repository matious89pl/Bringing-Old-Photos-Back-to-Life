 ...
 * @author ccaravac
 */
public class CustomSubscription32Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription32Sender.class);
