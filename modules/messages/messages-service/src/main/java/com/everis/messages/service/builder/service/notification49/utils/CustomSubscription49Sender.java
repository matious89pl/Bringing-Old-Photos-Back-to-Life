 ...
 * @author lperezve
 */
public class CustomSubscription49Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription49Sender.class);
