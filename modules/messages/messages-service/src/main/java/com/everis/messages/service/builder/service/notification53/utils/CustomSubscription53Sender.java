 ...
 * @author lperezve
 */
public class CustomSubscription53Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription53Sender.class);
