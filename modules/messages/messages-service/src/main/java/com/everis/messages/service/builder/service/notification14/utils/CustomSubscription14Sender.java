 ...
 * @author ccaravac
 */
public class CustomSubscription14Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription14Sender.class);
	...
	public void sendNotification14(User user) throws Exception {
