 ...
 * @author lperezve
 */
public class CustomSubscription65Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription65Sender.class);
