...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification26PortletKeys.NOTIFICATION26 }, service = UserNotificationHandler.class)
...
public class CustomNotification26Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification26Handler.class);

	public CustomNotification26Handler() {

		setPortletId(Notification26PortletKeys.NOTIFICATION26);
	}
