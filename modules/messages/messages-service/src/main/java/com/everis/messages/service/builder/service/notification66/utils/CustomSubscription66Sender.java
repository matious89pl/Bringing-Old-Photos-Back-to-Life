 ...
 * @author lperezve
 */
public class CustomSubscription66Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription66Sender.class);
