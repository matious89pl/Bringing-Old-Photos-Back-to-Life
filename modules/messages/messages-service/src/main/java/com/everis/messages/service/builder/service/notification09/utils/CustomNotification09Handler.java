...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification09PortletKeys.NOTIFICATION09 }, service = UserNotificationHandler.class)
...
public class CustomNotification09Handler extends BaseUserNotificationHandler {

	private static String _TITLE_KEY9 = "Message";
	private static String _BODY_KEY9 = "{0} sent you a new message";
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification09Handler.class);

	public CustomNotification09Handler() {

		setPortletId(Notification09PortletKeys.NOTIFICATION09);
	}
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY9);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY9, new Object[] { username });
