package com.everis.messages.service.builder.service.notification25.utils;
...
@Component(immediate = true, property = {}, service = Notifications25Utils.class)

public class Notifications25Utils {

	private static final Log logger = LogFactoryUtil.getLog(Notifications25Utils.class);
	...
	public void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext,
		...
		try {
			...
			String link = " <a style='color:#70ada3;' onclick='@LINK1'> Go to Category 3 Change Register</a>";

			title = "Category 3 Change Awaiting Implementation";
			body = "Category 3 Change " + cpReference + " is awaiting implementation " + link;
		...
		subscriptionSender.setClassName(Notifications25Utils.class.getName());
		...
		subscriptionSender.setMailId("custom_notitication25 to Change Proposer", 0);
		...
		subscriptionSender.addPersistedSubscribers(Notifications25Utils.class.getName(), 0);
