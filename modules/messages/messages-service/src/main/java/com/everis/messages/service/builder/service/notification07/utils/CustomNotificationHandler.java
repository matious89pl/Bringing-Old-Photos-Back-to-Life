...
public class CustomNotificationHandler extends BaseUserNotificationHandler {
	...
	private static String _TITLE_KEY07 = "Message";
	private static String _BODY_KEY07 = "{0} sent you a new message";
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotificationHandler.class);
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY07);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY07, new Object[] { username });
