...
/**
 * Provides the local service interface for CPImpact. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CPImpactLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CPImpactLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.everis.rec.cpimpact.service.impl.CPImpactLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cp impact local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CPImpactLocalServiceUtil} if injection and service tracking are not available.
	 */
