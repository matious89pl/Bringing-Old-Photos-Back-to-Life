...
/**
 * Provides the local service interface for Impacts. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ImpactsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ImpactsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.everis.rec.cpimpact.service.impl.ImpactsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the impacts local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ImpactsLocalServiceUtil} if injection and service tracking are not available.
	 */
