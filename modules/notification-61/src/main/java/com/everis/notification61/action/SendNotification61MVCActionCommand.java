package com.everis.notification61.action;

import com.everis.notification61.constants.CustomNotification61Type;
import com.everis.notification61.constants.CustomNotifications61Constants;
import com.everis.notification61.constants.Notification61PortletKeys;
import com.everis.notification61.custom.CustomNotification61Handler;
import com.everis.notification61.custom.CustomSubscription61Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification61PortletKeys.NOTIFICATION61,
...
public class SendNotification61MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification61MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification61Handler.setTitleKey(title);
		CustomNotification61Handler.setBodyKey(body);

		CustomSubscription61Sender subscriptionSender = new CustomSubscription61Sender();
		/**
		 * Set up the EMAIL TYPE custom notification
		 */
		String entryTitle = "Admin User Login";

		String fromName = PropsUtil.get(CustomNotifications61Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications61Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification61MVCActionCommand.class.getName());
		...
		int notificationType = CustomNotification61Type.NOTIFICATION_TYPE_USER_61;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification61PortletKeys.NOTIFICATION61;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification61MVCActionCommand.class.getName(), 0);
