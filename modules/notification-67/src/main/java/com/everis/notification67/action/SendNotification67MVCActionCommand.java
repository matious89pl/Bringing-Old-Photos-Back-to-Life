package com.everis.notification67.action;

import com.everis.notification67.constants.CustomNotification67Type;
import com.everis.notification67.constants.CustomNotifications67Constants;
import com.everis.notification67.constants.Notification67PortletKeys;
import com.everis.notification67.custom.CustomNotification67Handler;
import com.everis.notification67.custom.CustomSubscription67Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification67PortletKeys.NOTIFICATION67,
...
public class SendNotification67MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification67MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification67Handler.setTitleKey(title);
		CustomNotification67Handler.setBodyKey(body);

		CustomSubscription67Sender subscriptionSender = new CustomSubscription67Sender();
		/**
		 * Set up the EMAIL TYPE custom notification
		 */
		String entryTitle = "Admin User Login";

		String fromName = PropsUtil.get(CustomNotifications67Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications67Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification67MVCActionCommand.class.getName());
		...
		int notificationType = CustomNotification67Type.NOTIFICATION_TYPE_USER_67;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification67PortletKeys.NOTIFICATION67;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification67MVCActionCommand.class.getName(), 0);
