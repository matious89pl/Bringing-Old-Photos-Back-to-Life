package com.everis.notification38.action;

import com.everis.notification38.constants.CustomNotification38Type;
import com.everis.notification38.constants.CustomNotifications38Constants;
import com.everis.notification38.constants.Notification38PortletKeys;
import com.everis.notification38.custom.CustomNotification38Handler;
import com.everis.notification38.custom.CustomSubscription38Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification38PortletKeys.NOTIFICATION38,
...
public class SendNotification38MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification38MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification38Handler.setTitleKey("Tittle notification38");
		CustomNotification38Handler.setBodyKey("Body notification38");
		...
		subscriptionSender.setClassName(SendNotification38MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification38");
		subscriptionSender.setBody("Body notification38");

		subscriptionSender.setMailId("custom_notitication38", 0);
		...
		subscriptionSender.addPersistedSubscribers(SendNotification38MVCActionCommand.class.getName(), 0);
