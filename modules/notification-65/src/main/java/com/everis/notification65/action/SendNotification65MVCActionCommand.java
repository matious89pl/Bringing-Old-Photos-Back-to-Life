package com.everis.notification65.action;

import com.everis.notification65.constants.CustomNotification65Type;
import com.everis.notification65.constants.CustomNotifications65Constants;
import com.everis.notification65.constants.Notification65PortletKeys;
import com.everis.notification65.custom.CustomNotification65Handler;
import com.everis.notification65.custom.CustomSubscription65Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification65PortletKeys.NOTIFICATION65,
...
public class SendNotification65MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification65MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification65Handler.setTitleKey(title);
		CustomNotification65Handler.setBodyKey(body);

		CustomSubscription65Sender subscriptionSender = new CustomSubscription65Sender();
		/**
		 * Set up the EMAIL TYPE custom notification
		 */
		String entryTitle = "Admin User Login";

		String fromName = PropsUtil.get(CustomNotifications65Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications65Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification65MVCActionCommand.class.getName());
		...
		int notificationType = CustomNotification65Type.NOTIFICATION_TYPE_USER_65;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification65PortletKeys.NOTIFICATION65;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification65MVCActionCommand.class.getName(), 0);
