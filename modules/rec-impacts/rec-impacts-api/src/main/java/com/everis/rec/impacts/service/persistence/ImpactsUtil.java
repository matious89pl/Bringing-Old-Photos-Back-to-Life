...
package com.everis.rec.impacts.service.persistence;
...
public class ImpactsUtil {
	...
	public static Impacts findByImpactCategory_First(
		...
		throws com.everis.rec.impacts.exception.NoSuchImpactsException {
