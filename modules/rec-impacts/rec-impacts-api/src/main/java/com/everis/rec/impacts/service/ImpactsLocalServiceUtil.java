 ...
 * <code>com.everis.rec.impacts.service.impl.ImpactsLocalServiceImpl</code> and
...
public class ImpactsLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.everis.rec.impacts.service.impl.ImpactsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.everis.rec.impacts.model.Impacts addImpacts(
	 ...
	 */
	public static com.everis.rec.impacts.model.Impacts createImpacts(
		long impactId) {
	 ...
	 */
	public static com.everis.rec.impacts.model.Impacts deleteImpacts(
		com.everis.rec.impacts.model.Impacts impacts) {
	...
	public static com.everis.rec.impacts.model.Impacts fetchImpacts(
		long impactId) {

		return getService().fetchImpacts(impactId);
	}

	public static java.util.List<com.everis.rec.impacts.model.Impacts>
		findImpactsByCategory(String category) {

		return getService().findImpactsByCategory(category);
	}
	 ...
	 * @throws PortalException if a impacts with the primary key could not be found
	 */
	public static com.everis.rec.impacts.model.Impacts getImpacts(long impactId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static com.everis.rec.impacts.model.Impacts updateImpacts(
		com.everis.rec.impacts.model.Impacts impacts) {
