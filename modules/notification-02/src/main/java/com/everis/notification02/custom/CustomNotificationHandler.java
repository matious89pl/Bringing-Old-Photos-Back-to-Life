...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification02PortletKeys.NOTIFICATION02 }, service = UserNotificationHandler.class)
...
public class CustomNotificationHandler extends BaseUserNotificationHandler {
	...
	public CustomNotificationHandler() {
		...
		setPortletId(Notification02PortletKeys.NOTIFICATION02);
	}
