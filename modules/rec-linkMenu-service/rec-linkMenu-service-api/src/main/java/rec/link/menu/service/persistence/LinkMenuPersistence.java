...
/**
 * The persistence interface for the link menu service.
 *
 * <p>
 ...
 */
@ProviderType
public interface LinkMenuPersistence extends BasePersistence<LinkMenu> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LinkMenuUtil} to access the link menu persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<LinkMenu> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<LinkMenu> findByUuid(String uuid, int start, int end);
	 ...
	 */
	public java.util.List<LinkMenu> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<LinkMenu>
			orderByComparator);
	 ...
	 * @return the matching link menus
	 */
	public java.util.List<LinkMenu> findByUuid_C(String uuid, long companyId);
	 ...
	 * @return the range of matching link menus
	 */
	public java.util.List<LinkMenu> findByUuid_C(
	 ...
	 */
	public void cacheResult(java.util.List<LinkMenu> linkMenus);
	 ...
	 */
	public java.util.List<LinkMenu> findAll();
	 ...
	 */
	public java.util.List<LinkMenu> findAll(int start, int end);
