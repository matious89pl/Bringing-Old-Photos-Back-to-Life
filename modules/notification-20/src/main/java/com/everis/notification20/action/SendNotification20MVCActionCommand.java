package com.everis.notification20.action;

import com.everis.notification20.constants.CustomNotification20Type;
import com.everis.notification20.constants.CustomNotifications20Constants;
import com.everis.notification20.constants.Notification20PortletKeys;
import com.everis.notification20.custom.CustomNotification20Handler;
import com.everis.notification20.custom.CustomSubscription20Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification20PortletKeys.NOTIFICATION20,
...
public class SendNotification20MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification20MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification20Handler.setTitleKey("Tittle notification20");
		CustomNotification20Handler.setBodyKey("Body notification20");
		...
		subscriptionSender.setClassName(SendNotification20MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification20");
		subscriptionSender.setBody("Body notification20");

		subscriptionSender.setMailId("custom_notitication20", 0);
		...
		subscriptionSender.addPersistedSubscribers(SendNotification20MVCActionCommand.class.getName(), 0);
