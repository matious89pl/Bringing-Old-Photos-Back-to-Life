...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification46PortletKeys.NOTIFICATION46 }, service = UserNotificationHandler.class)
...
public class CustomNotification46Handler extends BaseUserNotificationHandler {

	private static String _TITLE_KEY46 = "Message";
	private static String _BODY_KEY46 = "{0} sent you a new message";
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification46Handler.class);

	public CustomNotification46Handler() {

		setPortletId(Notification46PortletKeys.NOTIFICATION46);
	}
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY46);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY46, new Object[] { username });
