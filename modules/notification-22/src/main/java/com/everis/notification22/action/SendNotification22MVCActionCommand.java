package com.everis.notification22.action;

import com.everis.notification22.constants.CustomNotification22Type;
import com.everis.notification22.constants.CustomNotifications22Constants;
import com.everis.notification22.constants.Notification22PortletKeys;
import com.everis.notification22.custom.CustomNotification22Handler;
import com.everis.notification22.custom.CustomSubscription22Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification22PortletKeys.NOTIFICATION22,
...
public class SendNotification22MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification22MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification22Handler.setTitleKey("Tittle notification22");
		CustomNotification22Handler.setBodyKey("Body notification22");
		...
		subscriptionSender.setClassName(SendNotification22MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification22");
		subscriptionSender.setBody("Body notification22");

		subscriptionSender.setMailId("custom_notitication22", 0);
		...
		subscriptionSender.addPersistedSubscribers(SendNotification22MVCActionCommand.class.getName(), 0);
