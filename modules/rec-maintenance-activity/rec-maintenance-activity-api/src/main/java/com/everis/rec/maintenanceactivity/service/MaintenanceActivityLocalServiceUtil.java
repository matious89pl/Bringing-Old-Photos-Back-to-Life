...
/**
 * Provides the local service utility for MaintenanceActivity. This utility wraps
 * <code>com.everis.rec.maintenanceactivity.service.impl.MaintenanceActivityLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MaintenanceActivityLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.everis.rec.maintenanceactivity.service.impl.MaintenanceActivityLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.everis.rec.maintenanceactivity.model.MaintenanceActivity
		addMaintenanceActivity(
			com.everis.rec.maintenanceactivity.model.MaintenanceActivity
				maintenanceActivity) {

		return getService().addMaintenanceActivity(maintenanceActivity);
	}
	...
	public static com.everis.rec.maintenanceactivity.model.MaintenanceActivity
		...
		return getService().createMaintenanceActivity(maintenanceactivityId);
	}
	...
	public static com.everis.rec.maintenanceactivity.model.MaintenanceActivity
		...
		return getService().deleteMaintenanceActivity(maintenanceactivityId);
	}
	...
	public static com.everis.rec.maintenanceactivity.model.MaintenanceActivity
		...
		return getService().deleteMaintenanceActivity(maintenanceActivity);
	}
	...
	public static com.everis.rec.maintenanceactivity.model.MaintenanceActivity
		...
		return getService().fetchMaintenanceActivity(maintenanceactivityId);
	}
	...
	public static com.everis.rec.maintenanceactivity.model.MaintenanceActivity
		...
		return getService().fetchMaintenanceActivityByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public static java.util.List
		...
		return getService().findMaintenanceActivityLogs(
	...
	public static java.util.List
		...
		return getService().getMaintenanceActivities(start, end);
	}
	 ...
	 */
	public static int getMaintenanceActivitiesCount() {
		return getService().getMaintenanceActivitiesCount();
	}
	...
	public static com.everis.rec.maintenanceactivity.model.MaintenanceActivity
		...
		return getService().getMaintenanceActivity(maintenanceactivityId);
	}
	...
	public static com.everis.rec.maintenanceactivity.model.MaintenanceActivity
		...
		return getService().getMaintenanceActivityByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public static com.everis.rec.maintenanceactivity.model.MaintenanceActivity
		...
		return getService().updateMaintenanceActivity(maintenanceActivity);
	}

	public static MaintenanceActivityLocalService getService() {
					...
					new ServiceTracker
						<MaintenanceActivityLocalService,
						 MaintenanceActivityLocalService>(
							 ...
							 MaintenanceActivityLocalService.class, null);
