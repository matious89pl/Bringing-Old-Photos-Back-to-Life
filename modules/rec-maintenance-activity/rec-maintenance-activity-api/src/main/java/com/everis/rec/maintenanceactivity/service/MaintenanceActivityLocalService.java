...
/**
 * Provides the local service interface for MaintenanceActivity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MaintenanceActivityLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MaintenanceActivityLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.everis.rec.maintenanceactivity.service.impl.MaintenanceActivityLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the maintenance activity local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MaintenanceActivityLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<MaintenanceActivity> findMaintenanceActivityLogs(
