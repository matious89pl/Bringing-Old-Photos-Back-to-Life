...
/**
 * Provides the local service interface for RecLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RecLogLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RecLogLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.everis.rec.service.activity.logs.service.impl.RecLogLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the rec log local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RecLogLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<RecLog> findByJournaArticleClassPK(
	...
	public RecLog registerActivityLog(
