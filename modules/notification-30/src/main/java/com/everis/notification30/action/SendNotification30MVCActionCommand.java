package com.everis.notification30.action;

import com.everis.notification30.constants.CustomNotification30Type;
import com.everis.notification30.constants.CustomNotifications30Constants;
import com.everis.notification30.constants.Notification30PortletKeys;
import com.everis.notification30.custom.CustomNotification30Handler;
import com.everis.notification30.custom.CustomSubscription30Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification30PortletKeys.NOTIFICATION30,
...
public class SendNotification30MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification30MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification30Handler.setTitleKey("Tittle notification30");
		CustomNotification30Handler.setBodyKey("Body notification30");
		...
		subscriptionSender.setClassName(SendNotification30MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification30");
		subscriptionSender.setBody("Body notification30");

		subscriptionSender.setMailId("custom_notitication30", 0);
		...
		subscriptionSender.addPersistedSubscribers(SendNotification30MVCActionCommand.class.getName(), 0);
