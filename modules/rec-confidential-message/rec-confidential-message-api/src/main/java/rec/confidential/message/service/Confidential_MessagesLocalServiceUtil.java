...
/**
 * Provides the local service utility for Confidential_Messages. This utility wraps
 * <code>rec.confidential.message.service.impl.Confidential_MessagesLocalServiceImpl</code> and
 ...
 * @generated
 */
public class Confidential_MessagesLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>rec.confidential.message.service.impl.Confidential_MessagesLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static rec.confidential.message.model.Confidential_Messages
		addConfidential_Messages(
			rec.confidential.message.model.Confidential_Messages
				confidential_Messages) {

		return getService().addConfidential_Messages(confidential_Messages);
	}
	...
	public static rec.confidential.message.model.Confidential_Messages
		...
		return getService().createConfidential_Messages(messageId);
	}
	...
	public static rec.confidential.message.model.Confidential_Messages
		...
		return getService().deleteConfidential_Messages(confidential_Messages);
	}
	...
	public static rec.confidential.message.model.Confidential_Messages
		...
		return getService().deleteConfidential_Messages(messageId);
	}
	...
	public static rec.confidential.message.model.Confidential_Messages
		...
		return getService().fetchConfidential_Messages(messageId);
	}
	...
	public static rec.confidential.message.model.Confidential_Messages
		...
		return getService().fetchConfidential_MessagesByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public static rec.confidential.message.model.Confidential_Messages
		...
		return getService().getConfidential_Messages(messageId);
	}
	...
	public static rec.confidential.message.model.Confidential_Messages
		...
		return getService().getConfidential_MessagesByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public static java.util.List
		...
		return getService().getConfidential_Messageses(start, end);
	}
	 ...
	 */
	public static int getConfidential_MessagesesCount() {
		return getService().getConfidential_MessagesesCount();
	}
	...
	public static rec.confidential.message.model.Confidential_Messages
		...
		return getService().updateConfidential_Messages(confidential_Messages);
	}

	public static Confidential_MessagesLocalService getService() {
	...
	static {
		...
		ServiceTracker
			<Confidential_MessagesLocalService,
			 Confidential_MessagesLocalService> serviceTracker =
				new ServiceTracker
					<Confidential_MessagesLocalService,
					 Confidential_MessagesLocalService>(
						 bundle.getBundleContext(),
						 Confidential_MessagesLocalService.class, null);
