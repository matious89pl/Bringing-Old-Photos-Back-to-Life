package com.everis.notification48.action;

import com.everis.notification48.constants.CustomNotification48Type;
import com.everis.notification48.constants.CustomNotifications48Constants;
import com.everis.notification48.constants.Notification48PortletKeys;
import com.everis.notification48.custom.CustomNotification48Handler;
import com.everis.notification48.custom.CustomSubscription48Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification48PortletKeys.NOTIFICATION48,
...
public class SendNotification48MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification48MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification48Handler.setTitleKey(title);
		CustomNotification48Handler.setBodyKey(body);

		CustomSubscription48Sender subscriptionSender = new CustomSubscription48Sender();
		/**
		 * Set up the EMAIL TYPE custom notification
		 */
		String entryTitle = "Admin User Login";

		String fromName = PropsUtil.get(CustomNotifications48Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications48Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification48MVCActionCommand.class.getName());
		...
		int notificationType = CustomNotification48Type.NOTIFICATION_TYPE_USER_48;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification48PortletKeys.NOTIFICATION48;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification48MVCActionCommand.class.getName(), 0);
