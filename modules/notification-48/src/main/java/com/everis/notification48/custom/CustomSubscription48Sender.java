 ...
 * @author ccaravac
 */
public class CustomSubscription48Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription48Sender.class);
