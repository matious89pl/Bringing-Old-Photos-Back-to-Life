package com.everis.notification47.action;

import com.everis.notification47.constants.CustomNotification47Type;
import com.everis.notification47.constants.CustomNotifications47Constants;
import com.everis.notification47.constants.Notification47PortletKeys;
import com.everis.notification47.custom.CustomNotification47Handler;
import com.everis.notification47.custom.CustomSubscription47Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification47PortletKeys.NOTIFICATION47,
...
public class SendNotification47MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification47MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification47Handler.setTitleKey(title);
		CustomNotification47Handler.setBodyKey(body);

		CustomSubscription47Sender subscriptionSender = new CustomSubscription47Sender();
		/**
		 * Set up the EMAIL TYPE custom notification
		 */
		String entryTitle = "Admin User Login";

		String fromName = PropsUtil.get(CustomNotifications47Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications47Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification47MVCActionCommand.class.getName());
		...
		int notificationType = CustomNotification47Type.NOTIFICATION_TYPE_USER_47;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification47PortletKeys.NOTIFICATION47;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification47MVCActionCommand.class.getName(), 0);
