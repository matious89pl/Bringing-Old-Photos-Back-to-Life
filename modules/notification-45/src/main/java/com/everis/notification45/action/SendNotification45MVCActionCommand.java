package com.everis.notification45.action;

import com.everis.notification45.constants.CustomNotification45Type;
import com.everis.notification45.constants.CustomNotifications45Constants;
import com.everis.notification45.constants.Notification45PortletKeys;
import com.everis.notification45.custom.CustomNotification45Handler;
import com.everis.notification45.custom.CustomSubscription45Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification45PortletKeys.NOTIFICATION45,
...
public class SendNotification45MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification45MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification45Handler.setTitleKey("Tittle notification45");
		CustomNotification45Handler.setBodyKey("Body notification45");
		...
		subscriptionSender.setClassName(SendNotification45MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification45");
		subscriptionSender.setBody("Body notification45");
		...
		subscriptionSender.addPersistedSubscribers(SendNotification45MVCActionCommand.class.getName(), 0);
