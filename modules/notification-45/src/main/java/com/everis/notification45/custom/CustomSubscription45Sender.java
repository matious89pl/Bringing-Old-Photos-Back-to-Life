 ...
 * @author e2517
 */
public class CustomSubscription45Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription45Sender.class);
