 ...
 * @author ccaravac
 */
public class CustomSubscription57Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription57Sender.class);
