package com.everis.notification57.action;

import com.everis.notification57.constants.CustomNotification57Type;
import com.everis.notification57.constants.CustomNotifications57Constants;
import com.everis.notification57.constants.Notification57PortletKeys;
import com.everis.notification57.custom.CustomNotification57Handler;
import com.everis.notification57.custom.CustomSubscription57Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification57PortletKeys.NOTIFICATION57,
...
public class SendNotification57MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification57MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification57Handler.setTitleKey(title);
		CustomNotification57Handler.setBodyKey(body);

		CustomSubscription57Sender subscriptionSender = new CustomSubscription57Sender();
		/**
		 * Set up the EMAIL TYPE custom notification
		 */
		String entryTitle = "Admin User Login";

		String fromName = PropsUtil.get(CustomNotifications57Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications57Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification57MVCActionCommand.class.getName());
		...
		int notificationType = CustomNotification57Type.NOTIFICATION_TYPE_USER_57;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification57PortletKeys.NOTIFICATION57;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification57MVCActionCommand.class.getName(), 0);
