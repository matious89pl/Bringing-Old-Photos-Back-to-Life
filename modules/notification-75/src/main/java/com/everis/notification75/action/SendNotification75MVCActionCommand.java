package com.everis.notification75.action;

import com.everis.notification75.constants.CustomNotification75Type;
import com.everis.notification75.constants.CustomNotifications75Constants;
import com.everis.notification75.constants.Notification75PortletKeys;
import com.everis.notification75.custom.CustomNotification75Handler;
import com.everis.notification75.custom.CustomSubscription75Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification75PortletKeys.NOTIFICATION75,
...
public class SendNotification75MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification75MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification75Handler.setTitleKey(title);
		CustomNotification75Handler.setBodyKey(body);
		...
		subscriptionSender.setClassName(SendNotification75MVCActionCommand.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(SendNotification75MVCActionCommand.class.getName(), 0);
