 ...
 * @author ccaravac
 */
public class CustomSubscription75Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription75Sender.class);
