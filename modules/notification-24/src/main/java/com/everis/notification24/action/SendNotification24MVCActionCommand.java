package com.everis.notification24.action;

import com.everis.notification24.constants.CustomNotification24Type;
import com.everis.notification24.constants.CustomNotifications24Constants;
import com.everis.notification24.constants.Notification24PortletKeys;
import com.everis.notification24.custom.CustomNotification24Handler;
import com.everis.notification24.custom.CustomSubscription24Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification24PortletKeys.NOTIFICATION24,
...
public class SendNotification24MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification24MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification24Handler.setTitleKey("Tittle notification24");
		CustomNotification24Handler.setBodyKey("Body notification24");
		...
		subscriptionSender.setClassName(SendNotification24MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification24");
		subscriptionSender.setBody("Body notification24");

		subscriptionSender.setMailId("custom_notitication24", 0);
		...
		subscriptionSender.addPersistedSubscribers(SendNotification24MVCActionCommand.class.getName(), 0);
