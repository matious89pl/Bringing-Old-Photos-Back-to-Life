 ...
 * @author ccaravac
 */
public class CustomSubscription24Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription24Sender.class);
