package com.everis.notification39.action;

import com.everis.notification39.constants.CustomNotification39Type;
import com.everis.notification39.constants.CustomNotifications39Constants;
import com.everis.notification39.constants.Notification39PortletKeys;
import com.everis.notification39.custom.CustomNotification39Handler;
import com.everis.notification39.custom.CustomSubscription39Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification39PortletKeys.NOTIFICATION39,
...
public class SendNotification39MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification39MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification39Handler.setTitleKey("Tittle notification39");
		CustomNotification39Handler.setBodyKey("Body notification39");
		...
		String fromName = PropsUtil.get(CustomNotifications39Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications39Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		CustomSubscription39Sender subscriptionSender = new CustomSubscription39Sender();

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification39MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification39");
		subscriptionSender.setBody("Body notification39");

		subscriptionSender.setMailId("custom_notitication39", 0);

		int notificationType = CustomNotification39Type.NOTIFICATION_TYPE_USER_39;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification39PortletKeys.NOTIFICATION39;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification39MVCActionCommand.class.getName(), 0);
