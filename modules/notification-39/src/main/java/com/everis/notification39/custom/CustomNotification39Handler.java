...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification39PortletKeys.NOTIFICATION39 }, service = UserNotificationHandler.class)
...
public class CustomNotification39Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification39Handler.class);

	public CustomNotification39Handler() {

		setPortletId(Notification39PortletKeys.NOTIFICATION39);
	}
