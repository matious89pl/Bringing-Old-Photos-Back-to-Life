 ...
 * @author ccaravac
 */
public class CustomSubscription73Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription73Sender.class);
