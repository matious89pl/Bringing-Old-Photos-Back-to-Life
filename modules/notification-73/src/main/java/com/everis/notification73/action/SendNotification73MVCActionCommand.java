package com.everis.notification73.action;

import com.everis.notification73.constants.CustomNotification73Type;
import com.everis.notification73.constants.CustomNotifications73Constants;
import com.everis.notification73.constants.Notification73PortletKeys;
import com.everis.notification73.custom.CustomNotification73Handler;
import com.everis.notification73.custom.CustomSubscription73Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification73PortletKeys.NOTIFICATION73,
...
public class SendNotification73MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification73MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification73Handler.setTitleKey(title);
		CustomNotification73Handler.setBodyKey(body);
		...
		subscriptionSender.setClassName(SendNotification73MVCActionCommand.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(SendNotification73MVCActionCommand.class.getName(), 0);
