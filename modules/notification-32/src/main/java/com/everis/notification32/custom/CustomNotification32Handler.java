...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification32PortletKeys.NOTIFICATION32 }, service = UserNotificationHandler.class)
...
public class CustomNotification32Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification32Handler.class);

	public CustomNotification32Handler() {

		setPortletId(Notification32PortletKeys.NOTIFICATION32);
	}
