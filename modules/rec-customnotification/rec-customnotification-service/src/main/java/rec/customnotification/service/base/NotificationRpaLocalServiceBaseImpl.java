...
package rec.customnotification.service.base;
...
/**
 * Provides the base implementation for the notification rpa local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link rec.customnotification.service.impl.NotificationRpaLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see rec.customnotification.service.impl.NotificationRpaLocalServiceImpl
 * @generated
 */
public abstract class NotificationRpaLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   NotificationRpaLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NotificationRpaLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>rec.customnotification.service.NotificationRpaLocalServiceUtil</code>.
	 */
	...
	public NotificationRpa addNotificationRpa(NotificationRpa notificationRpa) {
		...
		return notificationRpaPersistence.update(notificationRpa);
	}
	...
	public NotificationRpa createNotificationRpa(long customNotificationId) {
		return notificationRpaPersistence.create(customNotificationId);
	}
	...
	public NotificationRpa deleteNotificationRpa(long customNotificationId)
		...
		return notificationRpaPersistence.remove(customNotificationId);
	}
	...
	public NotificationRpa deleteNotificationRpa(
		...
		return notificationRpaPersistence.remove(notificationRpa);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			NotificationRpa.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return notificationRpaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return notificationRpaPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return notificationRpaPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return notificationRpaPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public NotificationRpa fetchNotificationRpa(long customNotificationId) {
		return notificationRpaPersistence.fetchByPrimaryKey(
	...
	public NotificationRpa fetchNotificationRpaByUuidAndGroupId(
		...
		return notificationRpaPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public NotificationRpa getNotificationRpa(long customNotificationId)
		...
		return notificationRpaPersistence.findByPrimaryKey(
			customNotificationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(notificationRpaLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(NotificationRpa.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(NotificationRpa.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<NotificationRpa>() {

				@Override
				public void performAction(NotificationRpa notificationRpa)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, notificationRpa);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return notificationRpaPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return notificationRpaLocalService.deleteNotificationRpa(
			(NotificationRpa)persistedModel);
	}

	public BasePersistence<NotificationRpa> getBasePersistence() {
		return notificationRpaPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return notificationRpaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<NotificationRpa> getNotificationRpasByUuidAndCompanyId(
		...
		return notificationRpaPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<NotificationRpa> getNotificationRpasByUuidAndCompanyId(
		...
		return notificationRpaPersistence.findByUuid_C(
	...
	public NotificationRpa getNotificationRpaByUuidAndGroupId(
		...
		return notificationRpaPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<NotificationRpa> getNotificationRpas(int start, int end) {
		return notificationRpaPersistence.findAll(start, end);
	}
	...
	public int getNotificationRpasCount() {
		return notificationRpaPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NotificationRpaLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		notificationRpaLocalService = (NotificationRpaLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NotificationRpaLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = notificationRpaPersistence.getDataSource();
	...
	protected NotificationRpaLocalService notificationRpaLocalService;

	@Reference
	protected NotificationRpaPersistence notificationRpaPersistence;
