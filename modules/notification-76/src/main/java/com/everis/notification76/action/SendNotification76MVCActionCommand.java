package com.everis.notification76.action;

import com.everis.notification76.constants.CustomNotification76Type;
import com.everis.notification76.constants.CustomNotifications76Constants;
import com.everis.notification76.constants.Notification76PortletKeys;
import com.everis.notification76.custom.CustomNotification76Handler;
import com.everis.notification76.custom.CustomSubscription76Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification76PortletKeys.NOTIFICATION76,
...
public class SendNotification76MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification76MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification76Handler.setTitleKey("Tittle notification76");
		CustomNotification76Handler.setBodyKey("Body notification76");
		...
		String fromName = PropsUtil.get(CustomNotifications76Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications76Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		CustomSubscription76Sender subscriptionSender = new CustomSubscription76Sender();

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification76MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification76");
		subscriptionSender.setBody("Body notification76");

		subscriptionSender.setMailId("custom_notitication76", 0);

		int notificationType = CustomNotification76Type.NOTIFICATION_TYPE_USER_76;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification76PortletKeys.NOTIFICATION76;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification76MVCActionCommand.class.getName(), 0);
