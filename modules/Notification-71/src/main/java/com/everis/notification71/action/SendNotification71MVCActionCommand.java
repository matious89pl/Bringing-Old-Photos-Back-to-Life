package com.everis.notification71.action;

import com.everis.notification71.constants.CustomNotification71Type;
import com.everis.notification71.constants.CustomNotifications71Constants;
import com.everis.notification71.constants.Notification71PortletKeys;
import com.everis.notification71.custom.CustomNotification71Handler;
import com.everis.notification71.custom.CustomSubscription71Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification71PortletKeys.NOTIFICATION71,
...
public class SendNotification71MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification71MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification71Handler.setTitleKey(title);
		CustomNotification71Handler.setBodyKey(body);

		CustomSubscription71Sender subscriptionSender = new CustomSubscription71Sender();
		/**
		 * Set up the EMAIL TYPE custom notification
		 */
		String entryTitle = "Admin User Login";

		String fromName = PropsUtil.get(CustomNotifications71Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications71Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification71MVCActionCommand.class.getName());
		...
		int notificationType = CustomNotification71Type.NOTIFICATION_TYPE_USER_71;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification71PortletKeys.NOTIFICATION71;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification71MVCActionCommand.class.getName(), 0);
