package com.everis.notification09.action;
...
import com.everis.notification09.constants.CustomNotifications09Constants;
import com.everis.notification09.constants.Notification09PortletKeys;
import com.everis.notification09.custom.CustomNotification09Handler;
import com.everis.notification09.custom.CustomSubscription09Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification09PortletKeys.NOTIFICATION09,
...
public class SendNotification09MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification09MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext,
		...
		String html = "<a id=\"consultation09\" href=\"https://www.google.com\" target=\"_blank\">Liferay</a>";
		Document link = (Document) Jsoup.parse(html);

		msgNotification = MessagesLocalServiceUtil.findByNameCompany("notification-09", serviceContext.getCompanyId());
		...
		subscriptionSender.setClassName(SendNotification09MVCActionCommand.class.getName());
		...
		subscriptionSender.setMailId("custom_notitication09", 0);
		...
		subscriptionSender.addPersistedSubscribers(SendNotification09MVCActionCommand.class.getName(), 0);
