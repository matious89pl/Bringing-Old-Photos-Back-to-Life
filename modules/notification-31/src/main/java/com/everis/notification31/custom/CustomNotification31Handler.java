...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification31PortletKeys.NOTIFICATION31 }, service = UserNotificationHandler.class)
...
public class CustomNotification31Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification31Handler.class);

	public CustomNotification31Handler() {

		setPortletId(Notification31PortletKeys.NOTIFICATION31);
	}
