package com.everis.notification31.action;

import com.everis.notification31.constants.CustomNotification31Type;
import com.everis.notification31.constants.CustomNotifications31Constants;
import com.everis.notification31.constants.Notification31PortletKeys;
import com.everis.notification31.custom.CustomNotification31Handler;
import com.everis.notification31.custom.CustomSubscription31Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification31PortletKeys.NOTIFICATION31,
...
public class SendNotification31MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification31MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification31Handler.setTitleKey("Tittle notification31");
		CustomNotification31Handler.setBodyKey("Body notification31");
		...
		subscriptionSender.setClassName(SendNotification31MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification31");
		subscriptionSender.setBody("Body notification31");

		subscriptionSender.setMailId("custom_notitication31", 0);
		...
		subscriptionSender.addPersistedSubscribers(SendNotification31MVCActionCommand.class.getName(), 0);
