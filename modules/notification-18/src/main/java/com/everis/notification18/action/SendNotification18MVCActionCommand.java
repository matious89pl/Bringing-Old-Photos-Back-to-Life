package com.everis.notification18.action;

import com.everis.notification18.constants.CustomNotification18Type;
import com.everis.notification18.constants.CustomNotifications18Constants;
import com.everis.notification18.constants.Notification18PortletKeys;
import com.everis.notification18.custom.CustomNotification18Handler;
import com.everis.notification18.custom.CustomSubscription18Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification18PortletKeys.NOTIFICATION18,
...
public class SendNotification18MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification18MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification18Handler.setTitleKey("Tittle notification18");
		CustomNotification18Handler.setBodyKey("Body notification18");
		...
		subscriptionSender.setClassName(SendNotification18MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification18");
		subscriptionSender.setBody("Body notification18");

		subscriptionSender.setMailId("custom_notitication18", 0);
		...
		subscriptionSender.addPersistedSubscribers(SendNotification18MVCActionCommand.class.getName(), 0);
