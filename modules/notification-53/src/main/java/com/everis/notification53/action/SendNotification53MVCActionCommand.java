package com.everis.notification53.action;

import com.everis.notification53.constants.CustomNotification53Type;
import com.everis.notification53.constants.CustomNotifications53Constants;
import com.everis.notification53.constants.Notification53PortletKeys;
import com.everis.notification53.custom.CustomNotification53Handler;
import com.everis.notification53.custom.CustomSubscription53Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification53PortletKeys.NOTIFICATION53,
...
public class SendNotification53MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification53MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification53Handler.setTitleKey(title);
		CustomNotification53Handler.setBodyKey(body);
		...
		subscriptionSender.setClassName(SendNotification53MVCActionCommand.class.getName());
		...
		subscriptionSender.addPersistedSubscribers(SendNotification53MVCActionCommand.class.getName(), 0);
