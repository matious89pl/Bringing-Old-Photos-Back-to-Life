package com.everis.notification28.action;

import com.everis.notification28.constants.CustomNotification28Type;
import com.everis.notification28.constants.CustomNotifications28Constants;
import com.everis.notification28.constants.Notification28PortletKeys;
import com.everis.notification28.custom.CustomNotification28Handler;
import com.everis.notification28.custom.CustomSubscription28Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification28PortletKeys.NOTIFICATION28,
...
public class SendNotification28MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification28MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification28Handler.setTitleKey("Tittle notification28");
		CustomNotification28Handler.setBodyKey("Body notification28");
		...
		String fromName = PropsUtil.get(CustomNotifications28Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications28Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		CustomSubscription28Sender subscriptionSender = new CustomSubscription28Sender();

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification28MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification28");
		subscriptionSender.setBody("Body notification28");

		subscriptionSender.setMailId("custom_notitication28", 0);

		int notificationType = CustomNotification28Type.NOTIFICATION_TYPE_USER_28;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification28PortletKeys.NOTIFICATION28;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification28MVCActionCommand.class.getName(), 0);
