...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification41PortletKeys.NOTIFICATION41 }, service = UserNotificationHandler.class)
...
public class CustomNotification41Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification41Handler.class);

	public CustomNotification41Handler() {

		setPortletId(Notification41PortletKeys.NOTIFICATION41);
	}
