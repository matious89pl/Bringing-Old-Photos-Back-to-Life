 ...
 * @author scruzhid
 */
public class CustomSubscription41Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription41Sender.class);
