package com.everis.notification41.action;

import com.everis.notification41.constants.CustomNotification41Type;
import com.everis.notification41.constants.CustomNotifications41Constants;
import com.everis.notification41.constants.Notification41PortletKeys;
import com.everis.notification41.custom.CustomNotification41Handler;
import com.everis.notification41.custom.CustomSubscription41Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification41PortletKeys.NOTIFICATION41,
...
public class SendNotification41MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification41MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification41Handler.setTitleKey("Tittle notification41");
		CustomNotification41Handler.setBodyKey("Body notification41");
		...
		subscriptionSender.setClassName(SendNotification41MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification41");
		subscriptionSender.setBody("Body notification41");

		subscriptionSender.setMailId("custom_notitication41", 0);
		...
		subscriptionSender.addPersistedSubscribers(SendNotification41MVCActionCommand.class.getName(), 0);
