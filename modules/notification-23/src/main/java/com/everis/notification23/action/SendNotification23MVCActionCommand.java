package com.everis.notification23.action;

import com.everis.notification23.constants.CustomNotification23Type;
import com.everis.notification23.constants.CustomNotifications23Constants;
import com.everis.notification23.constants.Notification23PortletKeys;
import com.everis.notification23.custom.CustomNotification23Handler;
import com.everis.notification23.custom.CustomSubscription23Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification23PortletKeys.NOTIFICATION23,
...
public class SendNotification23MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification23MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification23Handler.setTitleKey("Tittle notification23");
		CustomNotification23Handler.setBodyKey("Body notification23");
		...
		subscriptionSender.setClassName(SendNotification23MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification23");
		subscriptionSender.setBody("Body notification23");

		subscriptionSender.setMailId("custom_notitication23", 0);
		...
		subscriptionSender.addPersistedSubscribers(SendNotification23MVCActionCommand.class.getName(), 0);
