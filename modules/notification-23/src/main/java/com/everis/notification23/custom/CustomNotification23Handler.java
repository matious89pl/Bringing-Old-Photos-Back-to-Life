...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification23PortletKeys.NOTIFICATION23 }, service = UserNotificationHandler.class)
...
public class CustomNotification23Handler extends BaseUserNotificationHandler {
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification23Handler.class);

	public CustomNotification23Handler() {

		setPortletId(Notification23PortletKeys.NOTIFICATION23);
	}
