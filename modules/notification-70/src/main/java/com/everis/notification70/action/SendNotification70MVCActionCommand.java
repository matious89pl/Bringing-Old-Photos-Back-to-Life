package com.everis.notification70.action;

import com.everis.notification70.constants.CustomNotification70Type;
import com.everis.notification70.constants.CustomNotifications70Constants;
import com.everis.notification70.constants.Notification70PortletKeys;
import com.everis.notification70.custom.CustomNotification70Handler;
import com.everis.notification70.custom.CustomSubscription70Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification70PortletKeys.NOTIFICATION70,
...
public class SendNotification70MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification70MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		CustomNotification70Handler.setTitleKey(title);
		CustomNotification70Handler.setBodyKey(body);

		CustomSubscription70Sender subscriptionSender = new CustomSubscription70Sender();
		/**
		 * Set up the EMAIL TYPE custom notification
		 */
		String entryTitle = "Admin User Login";

		String fromName = PropsUtil.get(CustomNotifications70Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications70Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification70MVCActionCommand.class.getName());
		...
		int notificationType = CustomNotification70Type.NOTIFICATION_TYPE_USER_70;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification70PortletKeys.NOTIFICATION70;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification70MVCActionCommand.class.getName(), 0);
