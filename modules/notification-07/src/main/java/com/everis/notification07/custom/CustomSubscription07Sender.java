 ...
 * @author ccaravac
 */
public class CustomSubscription07Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription07Sender.class);
