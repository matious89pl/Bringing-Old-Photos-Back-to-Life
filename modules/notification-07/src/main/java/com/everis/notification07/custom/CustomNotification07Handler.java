...
@Component(immediate = true, property = {
		"javax.portlet.name=" + Notification07PortletKeys.NOTIFICATION07 }, service = UserNotificationHandler.class)
...
public class CustomNotification07Handler extends BaseUserNotificationHandler {

	private static String _TITLE_KEY7 = "Message";
	private static String _BODY_KEY7 = "{0} sent you a new message";
	...
	private static final Log logger = LogFactoryUtil.getLog(CustomNotification07Handler.class);

	public CustomNotification07Handler() {

		setPortletId(Notification07PortletKeys.NOTIFICATION07);
	}
	...
	protected String getBody(UserNotificationEvent userNotificationEvent, ServiceContext serviceContext)
		...
		String title = LanguageUtil.get(serviceContext.getLocale(), _TITLE_KEY7);

		String body = LanguageUtil.format(serviceContext.getLocale(), _BODY_KEY7, new Object[] { username });
