...
<style>
	.portlet-document-library .management-bar ul.navbar-nav li.nav-item .dropdown button.btn-primary, .portlet-document-library .management-bar ul.navbar-nav li.nav-item .dropdown button.btn-primary:hover {
...
<c:choose>
	...
	<c:otherwise>
		...
		<clay:management-toolbar
			displayContext="<%= dlAdminManagementToolbarDisplayContext %>"
		/>
