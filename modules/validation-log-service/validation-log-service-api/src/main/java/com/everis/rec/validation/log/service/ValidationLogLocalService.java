...
/**
 * Provides the local service interface for ValidationLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ValidationLogLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ValidationLogLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.everis.rec.validation.log.service.impl.ValidationLogLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the validation log local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ValidationLogLocalServiceUtil} if injection and service tracking are not available.
	 */
	public ValidationLog addNewValidationLog(
		String fileName, String uploadedBy, String uploadedFrom, long folderId,
		String logReason, long groupId, long companyId);
	...
	public List<ValidationLog> findValidationLogs(
