...
/**
 * Provides the local service utility for ValidationLog. This utility wraps
 * <code>com.everis.rec.validation.log.service.impl.ValidationLogLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ValidationLogLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.everis.rec.validation.log.service.impl.ValidationLogLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static com.everis.rec.validation.log.model.ValidationLog
		addNewValidationLog(
			String fileName, String uploadedBy, String uploadedFrom,
			long folderId, String logReason, long groupId, long companyId) {

		return getService().addNewValidationLog(
	...
	public static com.everis.rec.validation.log.model.ValidationLog
		...
		return getService().addValidationLog(validationLog);
	}
	...
	public static com.everis.rec.validation.log.model.ValidationLog
		...
		return getService().createValidationLog(validationLogId);
	}
	...
	public static com.everis.rec.validation.log.model.ValidationLog
		...
		return getService().deleteValidationLog(validationLogId);
	}
	...
	public static com.everis.rec.validation.log.model.ValidationLog
		...
		return getService().deleteValidationLog(validationLog);
	}
	...
	public static com.everis.rec.validation.log.model.ValidationLog
		fetchValidationLog(long validationLogId) {

		return getService().fetchValidationLog(validationLogId);
	}

	public static java.util.List
		<com.everis.rec.validation.log.model.ValidationLog> findValidationLogs(
			int searchContainerStart, int searchContainerEnd) {

		return getService().findValidationLogs(
	 ...
	 */
	public static com.everis.rec.validation.log.model.ValidationLog
			getValidationLog(long validationLogId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getValidationLog(validationLogId);
	}
	 ...
	 */
	public static java.util.List
		<com.everis.rec.validation.log.model.ValidationLog> getValidationLogs(
			int start, int end) {

		return getService().getValidationLogs(start, end);
	}
	 ...
	 */
	public static int getValidationLogsCount() {
		return getService().getValidationLogsCount();
	}
	...
	public static com.everis.rec.validation.log.model.ValidationLog
		...
		return getService().updateValidationLog(validationLog);
	}

	public static ValidationLogLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<ValidationLogLocalService, ValidationLogLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			ValidationLogLocalService.class);

		ServiceTracker<ValidationLogLocalService, ValidationLogLocalService>
			serviceTracker =
				new ServiceTracker
					<ValidationLogLocalService, ValidationLogLocalService>(
						bundle.getBundleContext(),
						ValidationLogLocalService.class, null);
