package com.everis.notification44.action;

import com.everis.notification44.constants.CustomNotification44Type;
import com.everis.notification44.constants.CustomNotifications44Constants;
import com.everis.notification44.constants.Notification44PortletKeys;
import com.everis.notification44.custom.CustomNotification44Handler;
import com.everis.notification44.custom.CustomSubscription44Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification44PortletKeys.NOTIFICATION44,
...
public class SendNotification44MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification44MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification44Handler.setTitleKey("Tittle notification44");
		CustomNotification44Handler.setBodyKey("Body notification44");
		...
		String fromName = PropsUtil.get(CustomNotifications44Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications44Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		CustomSubscription44Sender subscriptionSender = new CustomSubscription44Sender();

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification44MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification44");
		subscriptionSender.setBody("Body notification44");

		subscriptionSender.setMailId("custom_notitication44", 0);

		int notificationType = CustomNotification44Type.NOTIFICATION_TYPE_USER_44;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification44PortletKeys.NOTIFICATION44;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification44MVCActionCommand.class.getName(), 0);
