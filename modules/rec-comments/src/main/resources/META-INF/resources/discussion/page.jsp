				...
				Liferay.Util.fetch(form.action, {
					...
					.then(function (response) {
						...
						if (!exception) {
							...
							console.log("messageId: " + response.commentId);
							
							if ($(".confidentialComments").prop("checked") == true) {
								Liferay.Service(
								  '/confidential_messages.confidential_messages/add_confidential_message',
								  {
								    messageId: response.commentId,
								    companyId: 37204
								  },
								  function(obj) {
								    console.log(obj);
