package com.everis.notification63.action;

import com.everis.notification63.constants.CustomNotification63Type;
import com.everis.notification63.constants.CustomNotifications63Constants;
import com.everis.notification63.constants.Notification63PortletKeys;
import com.everis.notification63.custom.CustomNotification63Handler;
import com.everis.notification63.custom.CustomSubscription63Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification63PortletKeys.NOTIFICATION63,
...
public class SendNotification63MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification63MVCActionCommand.class);
	...
	protected void notifySubscribers(HashSet<User> userList, long userId, ServiceContext serviceContext)
		...
		String title = "Title Notification 63";
		String body = "Body Notification 63";
		
		CustomNotification63Handler.setTitleKey(title);
		CustomNotification63Handler.setBodyKey(body);

		CustomSubscription63Sender subscriptionSender = new CustomSubscription63Sender();
		/**
		 * Set up the EMAIL TYPE custom notification
		 */
		String entryTitle = "Admin User Login";

		String fromName = PropsUtil.get(CustomNotifications63Constants.EMAIL_FROM_NAME);
		String fromAddress = GetterUtil.getString(PropsUtil.get(CustomNotifications63Constants.EMAIL_FROM_ADDRESS),
				PropsUtil.get(PropsKeys.ADMIN_EMAIL_FROM_ADDRESS));

		subscriptionSender.setClassPK(0);
		subscriptionSender.setClassName(SendNotification63MVCActionCommand.class.getName());
		...
		int notificationType = CustomNotification63Type.NOTIFICATION_TYPE_USER_63;

		subscriptionSender.setNotificationType(notificationType);

		String portletId = Notification63PortletKeys.NOTIFICATION63;
		...
		subscriptionSender.addPersistedSubscribers(SendNotification63MVCActionCommand.class.getName(), 0);
