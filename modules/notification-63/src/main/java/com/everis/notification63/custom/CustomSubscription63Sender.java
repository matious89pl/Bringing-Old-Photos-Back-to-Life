 ...
 * @author ccaravac
 */
public class CustomSubscription63Sender extends SubscriptionSender {

	private static final Log logger = LogFactoryUtil.getLog(CustomSubscription63Sender.class);
