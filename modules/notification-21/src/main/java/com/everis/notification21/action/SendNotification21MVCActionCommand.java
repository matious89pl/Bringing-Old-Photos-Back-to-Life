package com.everis.notification21.action;

import com.everis.notification21.constants.CustomNotification21Type;
import com.everis.notification21.constants.CustomNotifications21Constants;
import com.everis.notification21.constants.Notification21PortletKeys;
import com.everis.notification21.custom.CustomNotification21Handler;
import com.everis.notification21.custom.CustomSubscription21Sender;
...
@Component(immediate = true, property = { "javax.portlet.name=" + Notification21PortletKeys.NOTIFICATION21,
...
public class SendNotification21MVCActionCommand implements MVCActionCommand {
	private static final Log logger = LogFactoryUtil.getLog(SendNotification21MVCActionCommand.class);
	...
	protected void notifySubscribers(List<User> userList, long userId, long companyId, ServiceContext serviceContext)
		...
		CustomNotification21Handler.setTitleKey("Tittle notification21");
		CustomNotification21Handler.setBodyKey("Body notification21");
		...
		subscriptionSender.setClassName(SendNotification21MVCActionCommand.class.getName());
		...
		subscriptionSender.setSubject("Tittle notification21");
		subscriptionSender.setBody("Body notification21");

		subscriptionSender.setMailId("custom_notitication21", 0);
		...
		subscriptionSender.addPersistedSubscribers(SendNotification21MVCActionCommand.class.getName(), 0);
