                                ...
                                <#if entry.isThumbnailVisible()>
                                    ...
                                    <#elseif entry.isUserPortraitVisible() && stringUtil.equals(entry.getClassName(), userClassName)>
                                        <@liferay_ui["user-portrait"]
                                            userId=entry.getAssetEntryUserId() />
                                ...
                                <section class="autofit-section">
                                    <div class="list-group-title">
                                        <#if entry.getClassName()=="com.liferay.document.library.kernel.model.DLFileEntry">
                                            ...
                                            <#elseif entry.getClassName()=="com.liferay.knowledge.base.model.KBArticle">
                                                <#--Fix to build KB link URL with code-->
                                                    ...
                                                    <#elseif entry.getClassName()=="com.liferay.journal.model.JournalArticle">
                                                        <#assign assetEntry=assetEntryLocalService.getEntry(entry.getClassName(), entry.getClassPK()) />
                                                        <#assign document=saxReaderUtil.read(assetEntry.getAssetRenderer().getArticle().getContent()) />
                                                        <#assign structure=assetEntry.getAssetRenderer().getArticle().getDDMStructure().getName(locale) />
                                                        <#assign fields = assetEntry.getAssetRenderer().getDDMFormValuesReader().getDDMFormValues().getDDMFormFieldValues()/>
                                                        <#assign valueCPReference=document.valueOf("//dynamic-element
                                                            [@name='ChangeProposalReference' ]
                                                            /dynamic-content/text()") />
                                                        
                                                                <a href=" ${entry.getViewURL()}">
                                                                                ${valueCPReference} ${entry.getHighlightedTitle()}
                                                                                </a>
                                                                                <#else>
                                                                                    <a href="${entry.getViewURL()}">
                                                                                        ${entry.getHighlightedTitle()}
                                            ...
                                            <#if entry.isModelResourceVisible()>
                                                <span class="subtext-item">
                                                    <strong>
                                                        ...
                                                        <#if entry.getClassName()=="com.liferay.journal.model.JournalArticle"> [${structure?replace("-", " ")?capitalize}]
                                                        </#if>
                                                    </strong>
                                                        ...
                                                        <#list entry.getDocumentFormFieldDisplayContexts() as fieldDisplayContext>
                                                            <tr>
                                                                <td class="key-column table-details-content">
                                                                    <strong>
                                                                        ${htmlUtil.escape(fieldDisplayContext.getName())}
                                                                    </strong>
                                                                </td>
